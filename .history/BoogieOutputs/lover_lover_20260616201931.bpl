...
procedure {:inline 0} mem_read_u8(a: int) returns (result: int);
...
procedure {:inline 0} mem_read_s8(a: int) returns (result: int);
...
procedure {:inline 0} mem_read_u16(a: int) returns (result: int);
...
procedure {:inline 0} mem_read_s16(a: int) returns (result: int);
...
procedure {:inline 0} mem_read_u32(a: int) returns (result: int);
...
procedure {:inline 0} mem_read_s32(a: int) returns (result: int);
...
procedure {:inline 0} mem_read_u64(a: int) returns (result: int);
...
procedure {:inline 0} mem_read_s64(a: int) returns (result: int);
...
procedure {:inline 0} mem_write_u8(a: int, v: int);
modifies $mem;
...
procedure {:inline 0} mem_write_u16(a: int, v: int);
modifies $mem;
...
procedure {:inline 0} mem_write_u32(a: int, v: int);
modifies $mem;
...
procedure {:inline 0} mem_write_u64(a: int, v: int);
modifies $mem;
...
procedure {:inline 0} memory_size() returns (result: int);
implementation memory_size() returns (result: int)
{
    result := $mem_pages;
}

procedure {:inline 0} memory_grow(delta: int) returns (oldSize: int);
modifies $mem_pages;
...
procedure {:inline 0} memory_fill(dst: int, value: int, len: int);
modifies $mem;
...
procedure {:inline 0} memory_copy(dst: int, src: int, len: int);
modifies $mem;
...
procedure {:inline 0} InitRuntime();
modifies $sp;
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
...
procedure {:inline 0} push(val: real);
modifies $sp;
modifies $stack;
requires((0) <= ($sp));
ensures(($sp) == ((old($sp)) + (1)));
...
var $table: [int]real;
var $table_size: int;
procedure {:inline 0} table_get(idx: int) returns (result: real);
implementation table_get(idx: int) returns (result: real)
{
    result := $table[idx];
}

procedure {:inline 0} table_set(idx: int, value: real);
modifies $table;
modifies $table_size;
...
procedure {:inline 0} table_size() returns (result: int);
implementation table_size() returns (result: int)
{
    result := $table_size;
}

procedure {:inline 0} table_grow(value: real, delta: int) returns (oldSize: int);
modifies $table;
modifies $table_size;
...
axiom((global_1) == (16914.0));
const global_2: real;

axiom((global_2) == (16914.0));
procedure {:inline 0} initGlobals();
modifies $mem_pages;
modifies global_0;
ensures(($mem_pages) == (0));
...
procedure {:inline 1} CorralChoice_lover_lover();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem_pages;
modifies global_0;
implementation CorralChoice_lover_lover()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry_lover_lover();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem_pages;
modifies global_0;
implementation BoogieEntry_lover_lover()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry_lover_lover();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem_pages;
modifies global_0;
implementation CorralEntry_lover_lover()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice_lover_lover();
    }
}
