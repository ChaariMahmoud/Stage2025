...
procedure  popArgs2() returns (a1: real, a2: real);
modifies $sp;
modifies $stack;
requires $sp >= 2;
ensures $sp >= 0;
...
// Corrected Boogie import/popping block for VeriWasm / lover_lover
// Replace your current popArgs + fimport_0..fimport_30 block with this one.
// Rule used:
//   - fimport with K arguments and no result:
//       requires $sp >= K;
//       ensures $sp == old($sp) - K;
//   - fimport with 0 arguments:
//       ensures $sp == old($sp);
...
procedure popArgs3() returns (a1: real, a2: real, a3: real);
modifies $sp, $stack;
requires $sp >= 3;
ensures $sp >= 0;
ensures $sp == old($sp) - 3;
...
procedure popArgs4() returns (a1: real, a2: real, a3: real, a4: real);
modifies $sp, $stack;
requires $sp >= 4;
ensures $sp >= 0;
ensures $sp == old($sp) - 4;
...
procedure popArgs5() returns (a1: real, a2: real, a3: real, a4: real, a5: real);
modifies $sp, $stack;
requires $sp >= 5;
ensures $sp >= 0;
ensures $sp == old($sp) - 5;
...
procedure popArgs6() returns (a1: real, a2: real, a3: real, a4: real, a5: real, a6: real);
modifies $sp, $stack;
requires $sp >= 6;
ensures $sp >= 0;
ensures $sp == old($sp) - 6;
...
requires $sp >= 2;
modifies $sp, $stack, $tmp1, $tmp2, $tmp3, $table, $table_size, $mem, $mem_pages;
ensures $sp == old($sp) - 2;
ensures $sp >= 0;
...
modifies $tmp1, $tmp2, $tmp3, $table, $table_size, $mem, $mem_pages;
ensures $sp == old($sp);
...
procedure popArgs8() returns (a1: real, a2: real, a3: real, a4: real, a5: real, a6: real, a7: real, a8: real);
modifies $sp;
modifies $stack;
requires $sp >= 8;
ensures $sp >= 0;
