...
{
    WriteCsv(
        Path.Combine(outDir, $"{datasetName}_benchmark_results.csv"),
        datasetResults
    );

    WriteSummary(
        Path.Combine(outDir, $"{datasetName}_summary.txt"),
        datasetResults
    );

    WriteCsv(
        Path.Combine(outDir, "all_benchmark_results.csv"),
        allResults
    );

    WriteSummary(
        Path.Combine(outDir, "all_summary.txt"),
        allResults
    );
}
