    ...
    static async Task<int> Main(string[] args)
    {
        ...
        foreach (var dataset in datasets)
        {
            ...
            foreach (var watFile in files)
            {
                ...
                var fileInfo = new FileInfo(watFile);

if (fileInfo.Length > maxWatSizeBytes)
{
    var skipped = new ContractResult(
        ...
        TranslationStatus: "SKIPPED_LARGE_FILE",
        ...
        TranslationTimeMs: 0,
        UnsupportedOps: "",
        Reason: $"File too large: {Math.Round(fileInfo.Length / 1024.0 / 1024.0, 2)} MB"
    );
    ...
    continue;
                ...
                long maxWatSizeBytes = 50L * 1024 * 1024; // 50 MB
