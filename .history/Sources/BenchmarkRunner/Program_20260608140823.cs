...
class Program
{
    const long MaxWatSizeBytes = 50L * 1024 * 1024; // 50 MB
    ...
    static readonly HashSet<string> Supported = new()
    {
        ...
        "i32.div_s", "i64.div_s", "i32.div_u", "i64.div_u",
        "f32.div", "f64.div",
        "i32.eq", "i64.eq", "f32.eq", "f64.eq",
        "i32.ne", "i64.ne", "f32.ne", "f64.ne",
        "i32.lt_s", "i64.lt_s", "i32.lt_u", "i64.lt_u",
        "f32.lt", "f64.lt",
        "i32.le_s", "i64.le_s", "i32.le_u", "i64.le_u",
        "f32.le", "f64.le",
        "i32.gt_s", "i64.gt_s", "i32.gt_u", "i64.gt_u",
        "f32.gt", "f64.gt",
        "i32.ge_s", "i64.ge_s", "i32.ge_u", "i64.ge_u",
        "f32.ge", "f64.ge",
        "i32.eqz", "i64.eqz",
        "i32.wrap_i64",
    ...
    {
        "module", "type", "func", "param", "result", "local",
        "global", "mut", "then", "else", "memory", "data",
        "export", "import", "table", "elem",
    };
                ...
                try
                {
                    ...
                    if (stat.Total > MaxInstructions)
                    {
                        var skipped = new ContractResult(
                            ...
                            TranslationTimeMs: 0,
                            UnsupportedOps: string.Join("; ", stat.UnsupportedOps.Select(x => $"{x.Key}:{x.Value}")),
    ...
    static void WriteSummary(string path, List<ContractResult> results)
    {
        ...
        sb.AppendLine($"Inlining timeouts: {inliningTimeouts} ({Percent(inliningTimeouts, total)}%)");
