...
namespace WasmToBoogie.Conversion
{
    public partial class WasmAstToBoogie
    {
        ...
        private static void AddInitRuntime(BoogieProgram program)
        {
            ...
            body.AddStatement(new BoogieAssignCmd(Id("$tmp1"), Real(0.0)));
            body.AddStatement(new BoogieAssignCmd(Id("$tmp2"), Real(0.0)));
            body.AddStatement(new BoogieAssignCmd(Id("$tmp3"), Real(0.0)));
