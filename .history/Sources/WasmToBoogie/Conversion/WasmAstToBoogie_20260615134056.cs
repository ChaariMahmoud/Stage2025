...
namespace WasmToBoogie.Conversion
{
    ...
    bn.Op
    is "i32.and" or "i64.and"
        or "i32.or" or "i64.or"
        or "i32.xor" or "i64.xor"
        or "i32.shl" or "i64.shl"
        or "i32.shr_s" or "i64.shr_s"
        or "i32.shr_u" or "i64.shr_u"
        or "i32.rotl" or "i64.rotl"
        or "i32.rotr" or "i64.rotr"
)
{
    string fun = bn.Op switch
    {
        ...
        _ => throw new NotSupportedException($"Unsupported bitwise op: {bn.Op}")
    };
    ...
    body.AddStatement(new BoogieCallCmd("push", new() { bitwiseExpr }, new()));
}
...
else if (bn.Op is "i32.rem_s" or "i64.rem_s" or "i32.rem_u" or "i64.rem_u")
{
    string fun = bn.Op switch
    {
        "i32.rem_s" or "i64.rem_s" => "int_rem_s",
        "i32.rem_u" or "i64.rem_u" => "int_rem_u",
        _ => throw new NotSupportedException($"Unsupported remainder op: {bn.Op}")
    };
    ...
    body.AddStatement(new BoogieCallCmd("push", new() { remExpr }, new()));
                ...
                case BrTableNode bt:
                {
                    ...
                    outBlk.AddStatement(new BoogieGotoCmd(ResolveBranchTargetLabel(bt.Default)));
                ...
                case IfNode ifn:
                {
                    ...
                    else
                    {
                        ...
                        elseExpr.AddStatement(
                            new BoogieCallCmd(
                                "push",
                                new() { new BoogieLiteralExpr(new Pfloat(0)) },
                                new()
                            )
                        );
                    }
