...
private static bool IsTypedArithmeticOp(string op) =>
    op is
        "i32.add" or "i32.sub" or "i32.mul" or
        "i64.add" or "i64.sub" or "i64.mul" or
        "f32.add" or "f32.sub" or "f32.mul" or "f32.div" or
        "f64.add" or "f64.sub" or "f64.mul" or "f64.div";

private static bool IsTypedComparisonOp(string op) =>
    op is
        "i32.eq" or "i32.ne" or
        "i32.lt_s" or "i32.lt_u" or
        "i32.gt_s" or "i32.gt_u" or
        "i32.le_s" or "i32.le_u" or
        "i32.ge_s" or "i32.ge_u" or

        "i64.eq" or "i64.ne" or
        "i64.lt_s" or "i64.lt_u" or
        "i64.gt_s" or "i64.gt_u" or
        "i64.le_s" or "i64.le_u" or
        "i64.ge_s" or "i64.ge_u" or

        "f32.eq" or "f32.ne" or
        "f32.lt" or "f32.gt" or "f32.le" or "f32.ge" or

        "f64.eq" or "f64.ne" or
        "f64.lt" or "f64.gt" or "f64.le" or "f64.ge";
...
case BinaryOpNode bn:
{
    ...
    {
        body.AddStatement(
            new BoogieCommentCmd($"// unsupported binary op in typed stage: {bn.Op}")
        );
    }
