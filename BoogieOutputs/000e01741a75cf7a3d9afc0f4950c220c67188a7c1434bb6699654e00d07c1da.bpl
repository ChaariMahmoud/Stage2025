...
label$1_end_1330:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$7_end_1338;
    }
    call push(loc2);
    call arg3 := popArgs1();
    goto label$6_end_1337;
label$7_end_1338:
    call push(loc2);
    call push(-16.0);
    call popToTmp1();
...
label$5_end_1335:
    ...
    idx := real_to_int($tmp1);
    if (((idx) < (0)) || ((idx) >= (3))) {
        goto label$15_end_1351;
    } else {
        if ((idx) == (0)) {
            goto label$15_end_1351;
        }
        if ((idx) == (1)) {
            goto label$14_end_1350;
        }
        if ((idx) == (2)) {
...
label$6_start_1392:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$6_start_1392;
    }
    // // unhandled raw instruction: i32.and
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$7_end_1394;
    }
    call push(loc1);
    call push(arg1);
    call popToTmp1();
