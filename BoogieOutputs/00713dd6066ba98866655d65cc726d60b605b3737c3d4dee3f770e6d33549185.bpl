...
axiom((global_13) == (10.0));
const global_14: real;

axiom((global_14) == (0.0));
const global_15: real;

axiom((global_15) == (272.0));
const global_16: real;

axiom((global_16) == (364.0));
...
procedure {:inline 1} CorralChoice__00713dd6066ba98866655d65cc726d60b605b3737c3d4dee3f770e6d33549185();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies global_1;
modifies global_2;
implementation CorralChoice__00713dd6066ba98866655d65cc726d60b605b3737c3d4dee3f770e6d33549185()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry__00713dd6066ba98866655d65cc726d60b605b3737c3d4dee3f770e6d33549185();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies global_1;
modifies global_2;
implementation BoogieEntry__00713dd6066ba98866655d65cc726d60b605b3737c3d4dee3f770e6d33549185()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry__00713dd6066ba98866655d65cc726d60b605b3737c3d4dee3f770e6d33549185();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies global_1;
modifies global_2;
implementation CorralEntry__00713dd6066ba98866655d65cc726d60b605b3737c3d4dee3f770e6d33549185()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice__00713dd6066ba98866655d65cc726d60b605b3737c3d4dee3f770e6d33549185();
    }
}
