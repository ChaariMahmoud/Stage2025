...
label$1_end_1469:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$3_end_1474;
    }
    call push(loc3);
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$5_end_1476;
    }
    call push(loc1);
    call push(24.0);
    call popToTmp1();
