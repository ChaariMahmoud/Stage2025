...
implementation func_43()
{
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$6_end_714;
    }
    // // unhandled raw instruction: i32.shr_u
    call loc2 := popArgs1();
    call push(10.0);
    call loc3 := popArgs1();
    goto label$5_end_713;
label$6_end_714:
    // // unhandled raw instruction: i32.and
    call push(-1.0);
    call popToTmp1();
