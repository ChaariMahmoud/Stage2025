...
label$20_end_136:
    ...
    call push(arg2);
    call push(arg3);
    // // unhandled raw instruction: i64.ctz
    // // wrap: no-op under real semantics
    call func_43();
    call push(loc3);
    call push(40.0);
...
label$6_end_157:
    ...
    // // unsupported const value: nan:0x400000
    call push(arg1);
...
procedure {:inline 1} CorralChoice__021f5732c13f9624aacafb300e7c20d6c029e2614b56f07bb1635070ee947695();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
modifies $stack;
modifies $mem;
implementation CorralChoice__021f5732c13f9624aacafb300e7c20d6c029e2614b56f07bb1635070ee947695()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry__021f5732c13f9624aacafb300e7c20d6c029e2614b56f07bb1635070ee947695();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
modifies $stack;
modifies $mem;
implementation BoogieEntry__021f5732c13f9624aacafb300e7c20d6c029e2614b56f07bb1635070ee947695()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry__021f5732c13f9624aacafb300e7c20d6c029e2614b56f07bb1635070ee947695();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
modifies $stack;
modifies $mem;
implementation CorralEntry__021f5732c13f9624aacafb300e7c20d6c029e2614b56f07bb1635070ee947695()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice__021f5732c13f9624aacafb300e7c20d6c029e2614b56f07bb1635070ee947695();
    }
}
