...
procedure {:inline 1} getCallDataSize();
modifies $tmp1;
modifies $sp;
modifies $stack;
implementation getCallDataSize()
{
}

procedure {:inline 1} storageStore();
modifies $tmp1;
modifies $sp;
modifies $stack;
implementation storageStore()
{
}
...
label$23_start_147:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$23_start_147;
    }
    goto label$21_end_144;
label$22_end_145:
    call push(0.0);
    call loc6 := popArgs1();
    call push(0.0);
...
label$15_end_232:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$17_end_235;
    }
    call push(loc2);
    call loc1 := popArgs1();
    goto label$16_end_234;
label$17_end_235:
    call push(loc5);
    call push(1.0);
    call push(loc2);
