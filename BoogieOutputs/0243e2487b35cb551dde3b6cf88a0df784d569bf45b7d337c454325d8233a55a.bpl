...
axiom((global_1) == (9016.0));
const global_2: real;

axiom((global_2) == (9016.0));
...
label$13_end_222:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$15_end_224;
    }
    // // unhandled raw instruction: i32.and
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$14_end_223;
    }
...
label$2_end_496:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$13_end_509;
    }
    // // unhandled raw instruction: i32.and
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$12_end_508;
    }
    goto label$11_end_507;
label$13_end_509:
    call push(arg4);
    call push(96.0);
    call popToTmp1();
...
label$8_end_792:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$12_end_798;
    }
    // // unhandled raw instruction: i32.and
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$11_end_797;
    }
...
label$8_end_817:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$12_end_823;
    }
    // // unhandled raw instruction: i32.and
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$11_end_822;
    }
...
label$8_end_892:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$12_end_898;
    }
    // // unhandled raw instruction: i32.and
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$11_end_897;
    }
...
label$7_end_953:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$9_end_955;
    }
    goto label$8_end_954;
label$10_end_956:
    call push(loc1);
    call func_2();
    call push(arg1);
...
label$5_end_984:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$7_end_986;
    }
    goto label$6_end_985;
label$8_end_987:
    call push(loc1);
    call func_2();
    call push(loc4);
...
label$5_end_1041:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$7_end_1043;
    }
    goto label$6_end_1042;
label$8_end_1044:
    call push(loc1);
    call func_2();
    call push(loc4);
...
label$11_end_1143:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$8_end_1140;
    }
    goto label$9_end_1141;
label$10_end_1142:
    // // unhandled raw instruction: i32.and
    call popToTmp1();
    call push(bool_to_real(($tmp1) == (0.0)));
...
label$9_end_1141:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$6_end_1138;
    }
    goto label$7_end_1139;
label$8_end_1140:
    // // unhandled raw instruction: i32.and
    call popToTmp1();
    call push(bool_to_real(($tmp1) == (0.0)));
...
procedure {:inline 1} CorralChoice__0243e2487b35cb551dde3b6cf88a0df784d569bf45b7d337c454325d8233a55a();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation CorralChoice__0243e2487b35cb551dde3b6cf88a0df784d569bf45b7d337c454325d8233a55a()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry__0243e2487b35cb551dde3b6cf88a0df784d569bf45b7d337c454325d8233a55a();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation BoogieEntry__0243e2487b35cb551dde3b6cf88a0df784d569bf45b7d337c454325d8233a55a()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry__0243e2487b35cb551dde3b6cf88a0df784d569bf45b7d337c454325d8233a55a();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation CorralEntry__0243e2487b35cb551dde3b6cf88a0df784d569bf45b7d337c454325d8233a55a()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice__0243e2487b35cb551dde3b6cf88a0df784d569bf45b7d337c454325d8233a55a();
    }
}
