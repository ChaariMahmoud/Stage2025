...
label$21_end_565:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$18_end_562;
    }
    goto label$17_end_561;
label$20_end_564:
    call push(loc1);
    call push(208.0);
    call popToTmp1();
