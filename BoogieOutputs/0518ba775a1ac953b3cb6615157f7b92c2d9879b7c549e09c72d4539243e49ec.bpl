...
label$5_end_1463:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$10_end_1469;
    }
    call push(arg3);
    call loc1 := popArgs1();
    goto label$9_end_1468;
label$10_end_1469:
    // // unhandled raw instruction: i32.and
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$12_end_1471;
    }
    call push(arg3);
    call loc1 := popArgs1();
    goto label$11_end_1470;
label$12_end_1471:
    call push(arg2);
    call push(-1.0);
    call popToTmp1();
...
label$7_start_1504:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$9_end_1508;
    }
    call push(0.0);
    call loc3 := popArgs1();
    goto label$8_end_1507;
label$9_end_1508:
    call push(arg1);
    call push(loc9);
    call popToTmp1();
