...
label$36_end_55:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$33_end_52;
    }
    goto label$32_end_51;
label$35_end_54:
    call push(arg1);
    call push(208.0);
    call popToTmp1();
...
label$42_end_63:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$39_end_60;
    }
    goto label$38_end_59;
label$41_end_62:
    call push(arg1);
    call push(208.0);
    call popToTmp1();
...
label$38_end_59:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$44_end_67;
    }
    goto label$43_end_66;
label$45_end_68:
    // // unhandled raw instruction: i32.and
    call loc2 := popArgs1();
    call push(loc2);
...
procedure {:inline 1} CorralChoice__05dbae9114f6ed3d2a566c1112933a02d1d83d288689a2ab966f7f1682c3dd4d();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
modifies $stack;
modifies $mem;
implementation CorralChoice__05dbae9114f6ed3d2a566c1112933a02d1d83d288689a2ab966f7f1682c3dd4d()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry__05dbae9114f6ed3d2a566c1112933a02d1d83d288689a2ab966f7f1682c3dd4d();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
modifies $stack;
modifies $mem;
implementation BoogieEntry__05dbae9114f6ed3d2a566c1112933a02d1d83d288689a2ab966f7f1682c3dd4d()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry__05dbae9114f6ed3d2a566c1112933a02d1d83d288689a2ab966f7f1682c3dd4d();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
modifies $stack;
modifies $mem;
implementation CorralEntry__05dbae9114f6ed3d2a566c1112933a02d1d83d288689a2ab966f7f1682c3dd4d()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice__05dbae9114f6ed3d2a566c1112933a02d1d83d288689a2ab966f7f1682c3dd4d();
    }
}
