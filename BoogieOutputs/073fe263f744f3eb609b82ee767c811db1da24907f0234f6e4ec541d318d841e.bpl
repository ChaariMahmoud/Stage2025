...
axiom((global_1) == (17744.0));
const global_2: real;

axiom((global_2) == (17744.0));
...
label$14_end_110:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$16_end_115;
    }
    goto label$15_end_114;
label$17_end_116:
    call push(arg1);
    call push(56.0);
    call popToTmp1();
...
label$16_end_309:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$18_end_317;
    }
label$19_start_318:
    // // unhandled raw instruction: i32.xor
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$21_end_321;
    }
    call push(loc5);
    call push(arg4);
    call popToTmp1();
...
label$24_end_329:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$25_end_335;
    }
    goto label$26_end_336;
label$27_end_337:
    call push(loc1);
    call push(32.0);
    call popToTmp1();
...
label$25_end_335:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$28_end_346;
    }
    goto label$29_end_347;
label$30_end_348:
    call push(loc1);
    call push(32.0);
    call popToTmp1();
...
label$37_end_373:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$39_end_377;
    }
    goto label$38_end_376;
label$40_end_378:
    call push(arg1);
    call push(96.0);
    call popToTmp1();
...
label$6_end_935:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$12_end_941;
    }
    goto label$11_end_940;
label$13_end_942:
    call push(loc6);
    call push(arg2);
    call push(arg1);
...
label$12_end_941:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$10_end_939;
    }
    goto label$9_end_938;
label$11_end_940:
    call push(loc2);
    call push(96.0);
    call popToTmp1();
...
label$10_end_939:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$8_end_937;
    }
    goto label$7_end_936;
label$9_end_938:
    call push(loc2);
    call push(100.0);
    call popToTmp1();
...
label$9_end_1047:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$7_end_1045;
    }
    goto label$6_end_1044;
label$8_end_1046:
    call push(loc2);
    call push(108.0);
    call popToTmp1();
...
implementation func_59()
{
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$2_end_1387;
    }
label$6_end_1393:
    // // unhandled raw instruction: i32.shl
    call func_61();
    call loc1 := popArgs1();
    goto label$1_end_1386;
label$5_end_1390:
    call push(loc2);
    call loc5 := popArgs1();
    call push(arg2);
...
label$8_end_1489:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$6_end_1487;
    }
    goto label$5_end_1486;
label$7_end_1488:
    call push(0.0);
    call loc10 := popArgs1();
    call push(loc5);
...
label$24_end_1511:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$21_end_1508;
    }
    goto label$20_end_1507;
label$23_end_1510:
    call push(loc1);
    call push(loc1);
    call popToTmp1();
...
label$3_end_1556:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$7_end_1563;
    }
    goto label$6_end_1562;
label$8_end_1564:
    call push(0.0);
    call loc4 := popArgs1();
label$9_start_1565:
...
label$10_start_1568:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$10_start_1568;
    }
    goto label$5_end_1561;
label$6_end_1562:
    call push(loc2);
    call loc7 := popArgs1();
label$5_end_1561:
...
implementation func_86()
{
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$2_end_1771;
    }
    call push(0.0);
    call popToTmp1();
    idx := (real_to_int($tmp1)) + (17684);
    call load_i := mem_read_s32(idx);
    call push(int_to_real(load_i));
    call loc1 := popArgs1();
    call push(loc1);
...
procedure {:inline 1} CorralChoice__073fe263f744f3eb609b82ee767c811db1da24907f0234f6e4ec541d318d841e();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation CorralChoice__073fe263f744f3eb609b82ee767c811db1da24907f0234f6e4ec541d318d841e()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry__073fe263f744f3eb609b82ee767c811db1da24907f0234f6e4ec541d318d841e();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation BoogieEntry__073fe263f744f3eb609b82ee767c811db1da24907f0234f6e4ec541d318d841e()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry__073fe263f744f3eb609b82ee767c811db1da24907f0234f6e4ec541d318d841e();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation CorralEntry__073fe263f744f3eb609b82ee767c811db1da24907f0234f6e4ec541d318d841e()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice__073fe263f744f3eb609b82ee767c811db1da24907f0234f6e4ec541d318d841e();
    }
}
