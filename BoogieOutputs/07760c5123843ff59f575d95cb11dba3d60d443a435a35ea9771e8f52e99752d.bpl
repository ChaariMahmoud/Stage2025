...
axiom((global_1) == (17500.0));
const global_2: real;

axiom((global_2) == (17500.0));
...
label$17_start_59:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$19_end_64;
    }
    goto label$18_end_63;
label$20_end_65:
    // // unhandled raw instruction: i32.and
    call loc6 := popArgs1();
    call push(loc6);
...
procedure {:inline 1} CorralChoice__07760c5123843ff59f575d95cb11dba3d60d443a435a35ea9771e8f52e99752d();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation CorralChoice__07760c5123843ff59f575d95cb11dba3d60d443a435a35ea9771e8f52e99752d()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry__07760c5123843ff59f575d95cb11dba3d60d443a435a35ea9771e8f52e99752d();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation BoogieEntry__07760c5123843ff59f575d95cb11dba3d60d443a435a35ea9771e8f52e99752d()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry__07760c5123843ff59f575d95cb11dba3d60d443a435a35ea9771e8f52e99752d();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation CorralEntry__07760c5123843ff59f575d95cb11dba3d60d443a435a35ea9771e8f52e99752d()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice__07760c5123843ff59f575d95cb11dba3d60d443a435a35ea9771e8f52e99752d();
    }
}
