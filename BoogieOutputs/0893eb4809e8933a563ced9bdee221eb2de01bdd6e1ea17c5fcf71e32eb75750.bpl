...
procedure {:inline 1} _emscripten_asm_const_i();
modifies $tmp1;
modifies $sp;
modifies $stack;
implementation _emscripten_asm_const_i()
{
}
...
label$166_start_141:
            ...
            if (real_to_bool($tmp1)) {
                call push(128.0);
                call loc1095 := popArgs1();
                goto label$163_end_139;
            } else {
                call push(loc557);
                call loc5 := popArgs1();
            }
            goto label$166_start_141;
label$167_end_143:
            call push(loc531);
            call push(loc512);
            call popToTmp1();
...
label$296_start_234:
            ...
            if (real_to_bool($tmp1)) {
                ...
                goto label$297_end_236;
            }
            goto label$296_start_234;
label$297_end_236:
            call push(loc935);
            call push(loc631);
            call popToTmp1();
...
label$93_start_328:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$94_end_330;
    } else {
        call push(loc212);
        call loc2 := popArgs1();
    }
    goto label$93_start_328;
label$94_end_330:
    call push(2288.0);
    call push(-1.0);
    call popToTmp2();
...
procedure {:inline 1} CorralChoice__0893eb4809e8933a563ced9bdee221eb2de01bdd6e1ea17c5fcf71e32eb75750();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies global_17;
modifies global_18;
implementation CorralChoice__0893eb4809e8933a563ced9bdee221eb2de01bdd6e1ea17c5fcf71e32eb75750()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry__0893eb4809e8933a563ced9bdee221eb2de01bdd6e1ea17c5fcf71e32eb75750();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies global_17;
modifies global_18;
implementation BoogieEntry__0893eb4809e8933a563ced9bdee221eb2de01bdd6e1ea17c5fcf71e32eb75750()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry__0893eb4809e8933a563ced9bdee221eb2de01bdd6e1ea17c5fcf71e32eb75750();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies global_17;
modifies global_18;
implementation CorralEntry__0893eb4809e8933a563ced9bdee221eb2de01bdd6e1ea17c5fcf71e32eb75750()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice__0893eb4809e8933a563ced9bdee221eb2de01bdd6e1ea17c5fcf71e32eb75750();
    }
}
