...
axiom((global_1) == (4195020.0));
const global_2: real;

axiom((global_2) == (4195020.0));
...
procedure {:inline 1} __faasm_read_state_ptr();
modifies $tmp1;
modifies $sp;
modifies $stack;
implementation __faasm_read_state_ptr()
{
}

procedure {:inline 1} __faasm_write_state();
modifies $tmp1;
modifies $sp;
modifies $stack;
implementation __faasm_write_state()
{
}

procedure {:inline 1} __faasm_write_output();
modifies $tmp1;
modifies $sp;
modifies $stack;
implementation __faasm_write_output()
{
}
...
implementation _faasm_func_0()
{
    ...
    call push(loc2);
    call push(7.0);
    call faasmWriteState();
    call push(4194304.0);
    call push(7.0);
    call faasmReadStatePtr();
    call loc3 := popArgs1();
    call push(4194304.0);
    call push(7.0);
    call faasmReadStatePtr();
...
procedure {:inline 1} faasmReadStatePtr();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation faasmReadStatePtr()
{
    var arg1: real;
    var arg2: real;
    var entry_sp: int;
...
procedure {:inline 1} faasmWriteState();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation faasmWriteState()
{
    var arg1: real;
    var arg2: real;
    var arg3: real;
    ...
    call push(arg2);
    call push(arg3);
    call __faasm_write_state();
}

procedure {:inline 1} faasmSetOutput();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
procedure {:inline 1} operator_new_unsigned_long_();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation operator_new_unsigned_long_()
{
    var arg1: real;
    var loc1: real;
    var entry_sp: int;
...
procedure {:inline 1} operator_delete_void__();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation operator_delete_void__()
{
    var arg1: real;
    var entry_sp: int;
    var idx: int;
...
procedure {:inline 1} void___std____2___anonymous_namespace_____libcpp_atomic_load_void________void____const______int____();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation void___std____2___anonymous_namespace_____libcpp_atomic_load_void________void____const______int____()
{
    var arg1: real;
    var arg2: real;
    var loc1: real;
...
procedure {:inline 1} std__get_new_handler__();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation std__get_new_handler__()
{
    var loc1: real;
    var loc2: real;
    var loc3: real;
    ...
    call push(loc1);
    call push(loc2);
    call void___std____2___anonymous_namespace_____libcpp_atomic_load_void________void____const______int____();
    call loc3 := popArgs1();
    call push(loc3);
    goto func_exit_18;
func_exit_18:
...
label$29_end_112:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$33_end_123;
    }
    call push(0.0);
    call arg1 := popArgs1();
    call push(0.0);
    call loc8 := popArgs1();
    goto label$32_end_122;
label$33_end_123:
    call push(loc3);
    call push(0.0);
    call push(25.0);
...
label$43_end_163:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$46_end_170;
    }
    call push(0.0);
    call popToTmp1();
    idx := (real_to_int($tmp1)) + (4194528);
    call load_i := mem_read_s32(idx);
    call push(int_to_real(load_i));
    call arg1 := popArgs1();
    call push(arg1);
...
label$46_end_170:
    ...
    call push(0.0);
    call popToTmp1();
    idx := (real_to_int($tmp1)) + (4194984);
    call load_i := mem_read_s32(idx);
    call push(int_to_real(load_i));
    call loc4 := popArgs1();
    goto label$47_end_175;
label$48_end_176:
    call push(0.0);
    call push(-1.0);
    call popToTmp2();
    call popToTmp1();
    idx := (real_to_int($tmp1)) + (4194988);
    store_i := real_to_int($tmp2);
...
label$47_end_175:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$49_end_177;
    }
    call push(0.0);
    call push(48.0);
    call popToTmp2();
    call popToTmp1();
    idx := (real_to_int($tmp1)) + (4195000);
    store_i := real_to_int($tmp2);
    call mem_write_u32(idx, store_i);
    goto label$1_end_20;
label$49_end_177:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$50_end_182;
    }
    call push(0.0);
    call popToTmp1();
    idx := (real_to_int($tmp1)) + (4194936);
    call load_i := mem_read_s32(idx);
    call push(int_to_real(load_i));
    call loc4 := popArgs1();
    call push(loc4);
...
label$66_start_221:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$66_start_221;
    }
    goto label$63_end_217;
label$65_end_219:
    call push(0.0);
    call popToTmp1();
    idx := (real_to_int($tmp1)) + (4194520);
...
label$69_start_229:
    ...
    call push(0.0);
    call popToTmp1();
    idx := (real_to_int($tmp1)) + (4194992);
    call load_i := mem_read_s32(idx);
    call push(int_to_real(load_i));
    call popToTmp2();
    call popToTmp1();
    idx := (real_to_int($tmp1)) + (4194532);
    store_i := real_to_int($tmp2);
    call mem_write_u32(idx, store_i);
    call push(0.0);
    call push(arg1);
...
label$78_start_250:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$78_start_250;
    }
    goto label$76_end_248;
label$77_end_249:
    call push(arg1);
    call popToTmp1();
    idx := (real_to_int($tmp1)) + (12);
...
label$116_end_369:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$120_end_376;
    }
    call push(0.0);
    call arg1 := popArgs1();
    goto label$119_end_375;
label$120_end_376:
    call push(31.0);
    call arg1 := popArgs1();
    call push(loc6);
...
label$4_end_547:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$2_start_544;
    }
label$1_end_542:
    call push(0.0);
    call popToTmp1();
    idx := (real_to_int($tmp1)) + (4195004);
    call load_i := mem_read_s32(idx);
    call push(int_to_real(load_i));
    call arg1 := popArgs1();
    call push(arg1);
...
procedure {:inline 1} CorralChoice__08a0b3b311e077598dcb78237afa086426430a162422c79f31bdb4082703adf9();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem_pages;
modifies global_0;
implementation CorralChoice__08a0b3b311e077598dcb78237afa086426430a162422c79f31bdb4082703adf9()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry__08a0b3b311e077598dcb78237afa086426430a162422c79f31bdb4082703adf9();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem_pages;
modifies global_0;
implementation BoogieEntry__08a0b3b311e077598dcb78237afa086426430a162422c79f31bdb4082703adf9()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry__08a0b3b311e077598dcb78237afa086426430a162422c79f31bdb4082703adf9();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem_pages;
modifies global_0;
implementation CorralEntry__08a0b3b311e077598dcb78237afa086426430a162422c79f31bdb4082703adf9()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice__08a0b3b311e077598dcb78237afa086426430a162422c79f31bdb4082703adf9();
    }
}
