...
label$39_end_87:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$36_end_84;
    }
    goto label$35_end_83;
label$38_end_86:
    call push(loc1);
    call push(208.0);
    call popToTmp1();
...
label$35_end_83:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$43_end_93;
    }
    goto label$42_end_92;
label$44_end_94:
    // // unhandled raw instruction: i32.and
    call loc2 := popArgs1();
    call push(loc2);
...
label$42_end_92:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$46_end_98;
    }
    goto label$45_end_97;
label$47_end_99:
    // // unhandled raw instruction: i32.and
    call loc2 := popArgs1();
    call push(loc2);
...
procedure {:inline 1} CorralChoice__08f702ca1be8593f518b2ea0494de3a98132c5ead3ccd14022f723a566363db2();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
modifies $stack;
modifies $mem;
implementation CorralChoice__08f702ca1be8593f518b2ea0494de3a98132c5ead3ccd14022f723a566363db2()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry__08f702ca1be8593f518b2ea0494de3a98132c5ead3ccd14022f723a566363db2();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
modifies $stack;
modifies $mem;
implementation BoogieEntry__08f702ca1be8593f518b2ea0494de3a98132c5ead3ccd14022f723a566363db2()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry__08f702ca1be8593f518b2ea0494de3a98132c5ead3ccd14022f723a566363db2();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
modifies $stack;
modifies $mem;
implementation CorralEntry__08f702ca1be8593f518b2ea0494de3a98132c5ead3ccd14022f723a566363db2()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice__08f702ca1be8593f518b2ea0494de3a98132c5ead3ccd14022f723a566363db2();
    }
}
