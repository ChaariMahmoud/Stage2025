...
axiom((global_0) == (4930376.0));
const global_1: real;

axiom((global_1) == (4930632.0));
const global_2: real;
...
procedure {:inline 1} CorralChoice__0906a979cb195ea8e0a2b1faacfe4d368fd701bd4454e63da99b14bdbed099ac();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_4;
implementation CorralChoice__0906a979cb195ea8e0a2b1faacfe4d368fd701bd4454e63da99b14bdbed099ac()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry__0906a979cb195ea8e0a2b1faacfe4d368fd701bd4454e63da99b14bdbed099ac();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_4;
implementation BoogieEntry__0906a979cb195ea8e0a2b1faacfe4d368fd701bd4454e63da99b14bdbed099ac()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry__0906a979cb195ea8e0a2b1faacfe4d368fd701bd4454e63da99b14bdbed099ac();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_4;
implementation CorralEntry__0906a979cb195ea8e0a2b1faacfe4d368fd701bd4454e63da99b14bdbed099ac()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice__0906a979cb195ea8e0a2b1faacfe4d368fd701bd4454e63da99b14bdbed099ac();
    }
}
