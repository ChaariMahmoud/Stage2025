...
label$25_end_127:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$28_end_134;
    }
    goto label$27_end_133;
label$29_end_135:
    call push(loc10);
    call popToTmp1();
    idx := (real_to_int($tmp1)) + (0);
...
label$5_end_1047:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$8_end_1052;
    }
    call push(loc3);
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$7_end_1051;
    }
    call push(loc2);
    call push(254.0);
    call popToTmp1();
