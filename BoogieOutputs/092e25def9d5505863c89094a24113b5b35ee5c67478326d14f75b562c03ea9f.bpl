...
label$4_start_1458:
    ...
    store_i := real_to_int($tmp2);
    call mem_write_u32(idx, store_i);
    goto label$5_end_1460;
label$6_end_1461:
    // // unhandled raw instruction: i32.and
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$8_end_1463;
    }
    // // unhandled raw instruction: i32.and
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$7_end_1462;
    }
label$8_end_1463:
    call push(loc3);
    call popToTmp1();
...
label$5_end_1484:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$4_start_1482;
    }
label$3_end_1481:
    // // unhandled raw instruction: i32.and
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$2_start_1479;
    }
label$1_end_1477:
}
...
label$3_start_1493:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$3_start_1493;
    }
    // // unhandled raw instruction: i32.and
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$2_start_1491;
    }
    call push(0.0);
    call loc4 := popArgs1();
    call push(3555.0);
...
label$5_start_1497:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$5_start_1497;
    }
    // // unhandled raw instruction: i32.and
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$4_start_1495;
    }
    call push(0.0);
    call loc4 := popArgs1();
    call push(3584.0);
