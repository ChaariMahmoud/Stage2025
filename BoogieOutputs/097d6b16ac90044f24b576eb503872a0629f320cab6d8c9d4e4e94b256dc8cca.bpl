...
label$27_end_67:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$33_end_79;
    }
    goto label$32_end_78;
label$34_end_80:
    // // unhandled raw instruction: i32.and
    call arg4 := popArgs1();
    call push(arg4);
