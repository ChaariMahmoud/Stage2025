...
axiom((global_1) == (17416.0));
const global_2: real;

axiom((global_2) == (17416.0));
...
label$27_end_71:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$33_end_83;
    }
    goto label$32_end_82;
label$34_end_84:
    call push(loc2);
    call push(16.0);
    call popToTmp1();
...
procedure {:inline 1} CorralChoice__097d6b16ac90044f24b576eb503872a0629f320cab6d8c9d4e4e94b256dc8cca();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem_pages;
modifies global_0;
implementation CorralChoice__097d6b16ac90044f24b576eb503872a0629f320cab6d8c9d4e4e94b256dc8cca()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry__097d6b16ac90044f24b576eb503872a0629f320cab6d8c9d4e4e94b256dc8cca();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem_pages;
modifies global_0;
implementation BoogieEntry__097d6b16ac90044f24b576eb503872a0629f320cab6d8c9d4e4e94b256dc8cca()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry__097d6b16ac90044f24b576eb503872a0629f320cab6d8c9d4e4e94b256dc8cca();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem_pages;
modifies global_0;
implementation CorralEntry__097d6b16ac90044f24b576eb503872a0629f320cab6d8c9d4e4e94b256dc8cca()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice__097d6b16ac90044f24b576eb503872a0629f320cab6d8c9d4e4e94b256dc8cca();
    }
}
