...
axiom((global_1) == (18152.0));
const global_2: real;

axiom((global_2) == (18152.0));
...
label$9_end_534:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$16_end_546;
    }
    goto label$15_end_545;
label$17_end_547:
    call push(loc1);
    call push(48.0);
    call popToTmp1();
...
procedure {:inline 1} CorralChoice__0a3909584b92b6a32ae8e923d78b4ed29133e4868972827f8cf370d441ae168a();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation CorralChoice__0a3909584b92b6a32ae8e923d78b4ed29133e4868972827f8cf370d441ae168a()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry__0a3909584b92b6a32ae8e923d78b4ed29133e4868972827f8cf370d441ae168a();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation BoogieEntry__0a3909584b92b6a32ae8e923d78b4ed29133e4868972827f8cf370d441ae168a()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry__0a3909584b92b6a32ae8e923d78b4ed29133e4868972827f8cf370d441ae168a();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation CorralEntry__0a3909584b92b6a32ae8e923d78b4ed29133e4868972827f8cf370d441ae168a()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice__0a3909584b92b6a32ae8e923d78b4ed29133e4868972827f8cf370d441ae168a();
    }
}
