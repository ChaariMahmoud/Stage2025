...
procedure {:inline 1} int64storageStore();
modifies $tmp1;
modifies $sp;
modifies $stack;
implementation int64storageStore()
{
}

procedure {:inline 1} int64storageLoad();
modifies $tmp1;
modifies $sp;
modifies $stack;
implementation int64storageLoad()
{
}

procedure {:inline 1} isStorageLocked();
modifies $tmp1;
modifies $sp;
modifies $stack;
implementation isStorageLocked()
{
}

procedure {:inline 1} int64finish();
modifies $tmp1;
modifies $sp;
modifies $stack;
implementation int64finish()
{
}

procedure {:inline 1} getBlockTimestamp();
modifies $tmp1;
modifies $sp;
modifies $stack;
implementation getBlockTimestamp()
{
}

procedure {:inline 1} setStorageLock();
modifies $tmp1;
modifies $sp;
modifies $stack;
implementation setStorageLock()
{
}

procedure {:inline 1} clearStorageLock();
modifies $tmp1;
modifies $sp;
modifies $stack;
implementation clearStorageLock()
{
}
...
procedure {:inline 1} CorralChoice__0a673c705a8f74d54c13f634ac85e0a6fed2f8adc7a5bbd0fc34f27ddc6da34f();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem_pages;
modifies global_0;
implementation CorralChoice__0a673c705a8f74d54c13f634ac85e0a6fed2f8adc7a5bbd0fc34f27ddc6da34f()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry__0a673c705a8f74d54c13f634ac85e0a6fed2f8adc7a5bbd0fc34f27ddc6da34f();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem_pages;
modifies global_0;
implementation BoogieEntry__0a673c705a8f74d54c13f634ac85e0a6fed2f8adc7a5bbd0fc34f27ddc6da34f()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry__0a673c705a8f74d54c13f634ac85e0a6fed2f8adc7a5bbd0fc34f27ddc6da34f();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem_pages;
modifies global_0;
implementation CorralEntry__0a673c705a8f74d54c13f634ac85e0a6fed2f8adc7a5bbd0fc34f27ddc6da34f()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice__0a673c705a8f74d54c13f634ac85e0a6fed2f8adc7a5bbd0fc34f27ddc6da34f();
    }
}
