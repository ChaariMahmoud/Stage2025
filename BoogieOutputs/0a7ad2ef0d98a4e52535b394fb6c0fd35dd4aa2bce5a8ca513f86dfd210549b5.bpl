...
label$36_end_169:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$33_end_166;
    }
    goto label$32_end_165;
label$35_end_168:
    call push(loc5);
    call push(208.0);
    call popToTmp1();
...
label$46_end_185:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$43_end_182;
    }
    goto label$42_end_181;
label$45_end_184:
    call push(loc5);
    call push(208.0);
    call popToTmp1();
...
label$42_end_181:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$49_end_191;
    }
    goto label$48_end_190;
label$50_end_192:
    call push(loc6);
    call push(16.0);
    call popToTmp1();
...
label$33_end_477:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$40_end_488;
    }
    goto label$39_end_487;
label$41_end_489:
    call push(arg1);
    call push(8.0);
    call popToTmp1();
...
label$48_end_511:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$47_start_509;
    }
    goto label$45_end_507;
label$46_end_508:
    call push(0.0);
    call arg2 := popArgs1();
label$45_end_507:
...
procedure {:inline 1} CorralChoice__0a7ad2ef0d98a4e52535b394fb6c0fd35dd4aa2bce5a8ca513f86dfd210549b5();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation CorralChoice__0a7ad2ef0d98a4e52535b394fb6c0fd35dd4aa2bce5a8ca513f86dfd210549b5()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry__0a7ad2ef0d98a4e52535b394fb6c0fd35dd4aa2bce5a8ca513f86dfd210549b5();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation BoogieEntry__0a7ad2ef0d98a4e52535b394fb6c0fd35dd4aa2bce5a8ca513f86dfd210549b5()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry__0a7ad2ef0d98a4e52535b394fb6c0fd35dd4aa2bce5a8ca513f86dfd210549b5();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation CorralEntry__0a7ad2ef0d98a4e52535b394fb6c0fd35dd4aa2bce5a8ca513f86dfd210549b5()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice__0a7ad2ef0d98a4e52535b394fb6c0fd35dd4aa2bce5a8ca513f86dfd210549b5();
    }
}
