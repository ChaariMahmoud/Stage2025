...
label$21_end_166:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$18_end_163;
    }
    goto label$17_end_162;
label$20_end_165:
    call push(loc4);
    call push(208.0);
    call popToTmp1();
...
label$7_end_852:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$12_end_857;
    }
    // // unhandled raw instruction: i32.shr_u
    call loc4 := popArgs1();
    goto label$11_end_856;
label$12_end_857:
    call push(arg1);
    call popToTmp1();
    idx := (real_to_int($tmp1)) + (4);
