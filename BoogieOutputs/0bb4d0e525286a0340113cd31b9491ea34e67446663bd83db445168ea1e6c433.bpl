...
implementation func_0()
{
    ...
    call pop();
    call push(0.0);
    // // numeric cast i32.trunc_f32_u: no-op under real semantics
    call pop();
    call push(0.0);
    ...
    call pop();
    call push(0.0);
    // // numeric cast i64.trunc_f32_u: no-op under real semantics
    call pop();
    call push(0.0);
    ...
    call pop();
    call push(0.0);
    // // numeric cast f32.convert_i64_u: no-op under real semantics
    call pop();
    call push(0.0);
