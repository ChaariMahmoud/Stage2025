...
procedure {:inline 1} GenerateCards();
modifies $tmp1;
modifies $sp;
modifies $stack;
implementation GenerateCards()
{
}

procedure {:inline 1} UpdateTriesTotal();
modifies $tmp1;
modifies $sp;
modifies $stack;
implementation UpdateTriesTotal()
{
}

procedure {:inline 1} FlipCard();
modifies $tmp1;
modifies $sp;
modifies $stack;
...
procedure {:inline 1} RemoveCards();
modifies $tmp1;
modifies $sp;
modifies $stack;
implementation RemoveCards()
{
}

procedure {:inline 1} LevelComplete();
modifies $tmp1;
modifies $sp;
modifies $stack;
...
procedure {:inline 1} SeedRandomNumberGenerator();
modifies $tmp1;
modifies $sp;
modifies $stack;
implementation SeedRandomNumberGenerator()
{
}

procedure {:inline 1} GetRandomNumber();
modifies $tmp1;
modifies $sp;
modifies $stack;
implementation GetRandomNumber()
{
}
...
procedure {:inline 1} InitializeRowsAndColumns();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies global_3;
modifies global_4;
implementation InitializeRowsAndColumns()
{
    var arg1: real;
    var entry_sp: int;
    var idx: int;
...
procedure {:inline 1} ResetSelectedCardValues();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies global_11;
modifies global_12;
implementation ResetSelectedCardValues()
{
    var entry_sp: int;
    var idx: int;
    var load_i: int;
...
procedure {:inline 1} InitializeCards();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies global_1;
modifies global_6;
implementation InitializeCards()
{
    var arg1: real;
    var loc1: real;
    var entry_sp: int;
...
procedure {:inline 1} PopulateArray();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
procedure {:inline 1} GetMemoryLocationFromIndex();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation GetMemoryLocationFromIndex()
{
    var arg1: real;
    var entry_sp: int;
    var idx: int;
...
procedure {:inline 1} ShuffleArray();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
procedure {:inline 1} GetCardValue();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
procedure {:inline 1} CardSelected();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
procedure {:inline 1} IsFirstCard();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
procedure {:inline 1} SecondCardSelectedCallback();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies global_6;
modifies global_13;
implementation SecondCardSelectedCallback()
{
    var loc1: real;
    var entry_sp: int;
    var idx: int;
...
procedure {:inline 1} ReplayLevel();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
procedure {:inline 1} PlayNextLevel();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
procedure {:inline 1} CorralChoice__2ed7bf4f75f0680557610dccf12c85fc65b4582a019e6308ce9abde09e56ea19();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies global_12;
modifies global_13;
implementation CorralChoice__2ed7bf4f75f0680557610dccf12c85fc65b4582a019e6308ce9abde09e56ea19()
{
    var c: int;
    var argTmp: real;
    havoc c;
    ...
    if ((c) == (0)) {
        ...
        call SecondCardSelectedCallback();
    } else if ((c) == (11)) {
        call ReplayLevel();
    } else if ((c) == (12)) {
        call PlayNextLevel();
...
procedure BoogieEntry__2ed7bf4f75f0680557610dccf12c85fc65b4582a019e6308ce9abde09e56ea19();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies global_12;
modifies global_13;
implementation BoogieEntry__2ed7bf4f75f0680557610dccf12c85fc65b4582a019e6308ce9abde09e56ea19()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry__2ed7bf4f75f0680557610dccf12c85fc65b4582a019e6308ce9abde09e56ea19();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies global_12;
modifies global_13;
implementation CorralEntry__2ed7bf4f75f0680557610dccf12c85fc65b4582a019e6308ce9abde09e56ea19()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice__2ed7bf4f75f0680557610dccf12c85fc65b4582a019e6308ce9abde09e56ea19();
    }
}
