...
label$5_end_957:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$8_end_962;
    }
    call push(loc6);
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$7_end_961;
    }
    call push(loc5);
    call push(1.0);
    call popToTmp1();
