...
axiom((global_1) == (17616.0));
const global_2: real;

axiom((global_2) == (17616.0));
...
label$19_end_72:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$23_end_76;
    }
    // // unhandled raw instruction: i64.shl
    call loc13 := popArgs1();
    goto label$22_end_75;
label$23_end_76:
    // // unhandled raw instruction: i64.and
    call loc13 := popArgs1();
label$22_end_75:
...
label$25_end_80:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$30_end_91;
    }
    goto label$29_end_90;
label$31_end_92:
    call push(loc1);
    call push(loc1);
    call push(80.0);
...
label$21_end_158:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$18_end_155;
    }
    goto label$17_end_154;
label$20_end_157:
    call push(loc3);
    call push(-48.0);
    call popToTmp1();
...
label$17_end_154:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$23_end_162;
    }
    goto label$22_end_161;
label$24_end_163:
    call push(loc1);
    call push(40.0);
    call popToTmp1();
...
implementation func_78()
{
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$2_end_1105;
    }
    call push(0.0);
    call popToTmp1();
    idx := (real_to_int($tmp1)) + (17604);
    call load_i := mem_read_s32(idx);
    call push(int_to_real(load_i));
    call loc1 := popArgs1();
    call push(loc1);
...
procedure {:inline 1} CorralChoice__359adaabf4ee648e8234e7ff6a8fb160b1b8d9ffd4f40da400599cbc002e7a0b();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation CorralChoice__359adaabf4ee648e8234e7ff6a8fb160b1b8d9ffd4f40da400599cbc002e7a0b()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry__359adaabf4ee648e8234e7ff6a8fb160b1b8d9ffd4f40da400599cbc002e7a0b();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation BoogieEntry__359adaabf4ee648e8234e7ff6a8fb160b1b8d9ffd4f40da400599cbc002e7a0b()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry__359adaabf4ee648e8234e7ff6a8fb160b1b8d9ffd4f40da400599cbc002e7a0b();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation CorralEntry__359adaabf4ee648e8234e7ff6a8fb160b1b8d9ffd4f40da400599cbc002e7a0b()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice__359adaabf4ee648e8234e7ff6a8fb160b1b8d9ffd4f40da400599cbc002e7a0b();
    }
}
