...
implementation func_0()
{
    ...
    if (real_to_bool($tmp1)) {
        call push(1634760832.0);
        call loc2 := popArgs1();
        call push(857760896.0);
        call loc3 := popArgs1();
        call push(2036477184.0);
        call loc4 := popArgs1();
        call push(1797285248.0);
        call loc5 := popArgs1();
    } else {
        call push(arg4);
        call popToTmp1();
...
procedure {:inline 1} CorralChoice__3914ef8ba88fe90e5382c0a4b7d3ae31b5cdd917bbf4411b0c87388b3056f8a5();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
modifies $stack;
modifies $mem;
implementation CorralChoice__3914ef8ba88fe90e5382c0a4b7d3ae31b5cdd917bbf4411b0c87388b3056f8a5()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry__3914ef8ba88fe90e5382c0a4b7d3ae31b5cdd917bbf4411b0c87388b3056f8a5();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
modifies $stack;
modifies $mem;
implementation BoogieEntry__3914ef8ba88fe90e5382c0a4b7d3ae31b5cdd917bbf4411b0c87388b3056f8a5()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry__3914ef8ba88fe90e5382c0a4b7d3ae31b5cdd917bbf4411b0c87388b3056f8a5();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
modifies $stack;
modifies $mem;
implementation CorralEntry__3914ef8ba88fe90e5382c0a4b7d3ae31b5cdd917bbf4411b0c87388b3056f8a5()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice__3914ef8ba88fe90e5382c0a4b7d3ae31b5cdd917bbf4411b0c87388b3056f8a5();
    }
}
