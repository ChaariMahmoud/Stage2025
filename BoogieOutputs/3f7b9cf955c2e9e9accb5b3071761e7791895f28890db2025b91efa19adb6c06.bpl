...
procedure {:inline 1} _ZN5boost15throw_exceptionERKSt9exception();
modifies $tmp1;
modifies $sp;
modifies $stack;
implementation _ZN5boost15throw_exceptionERKSt9exception()
{
}
...
procedure {:inline 1} blockHash();
modifies $tmp1;
modifies $sp;
modifies $stack;
implementation blockHash()
{
}
...
procedure {:inline 1} emitEvent();
modifies $tmp1;
modifies $sp;
modifies $stack;
implementation emitEvent()
{
}
...
procedure {:inline 1} getStateSize();
modifies $tmp1;
modifies $sp;
modifies $stack;
implementation getStateSize()
{
}
...
label$21_end_632:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$25_end_641;
    }
    call push(arg1);
    call arg3 := popArgs1();
    goto label$24_end_640;
label$25_end_641:
    call push(arg1);
    call popToTmp1();
    idx := (real_to_int($tmp1)) + (4);
...
label$13_end_701:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$17_end_707;
    }
    call push(arg1);
    call loc8 := popArgs1();
    goto label$16_end_706;
label$17_end_707:
    call push(arg1);
    call popToTmp1();
    idx := (real_to_int($tmp1)) + (4);
...
procedure {:inline 1} CorralChoice__3f7b9cf955c2e9e9accb5b3071761e7791895f28890db2025b91efa19adb6c06();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation CorralChoice__3f7b9cf955c2e9e9accb5b3071761e7791895f28890db2025b91efa19adb6c06()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry__3f7b9cf955c2e9e9accb5b3071761e7791895f28890db2025b91efa19adb6c06();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation BoogieEntry__3f7b9cf955c2e9e9accb5b3071761e7791895f28890db2025b91efa19adb6c06()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry__3f7b9cf955c2e9e9accb5b3071761e7791895f28890db2025b91efa19adb6c06();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation CorralEntry__3f7b9cf955c2e9e9accb5b3071761e7791895f28890db2025b91efa19adb6c06()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice__3f7b9cf955c2e9e9accb5b3071761e7791895f28890db2025b91efa19adb6c06();
    }
}
