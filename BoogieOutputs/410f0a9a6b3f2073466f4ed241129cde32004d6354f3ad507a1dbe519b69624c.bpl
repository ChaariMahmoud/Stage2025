...
label$21_end_487:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$18_end_484;
    }
    goto label$17_end_483;
label$20_end_486:
    call push(loc1);
    call push(208.0);
    call popToTmp1();
...
label$7_end_706:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$12_end_711;
    }
    // // unhandled raw instruction: i32.shr_u
    call loc4 := popArgs1();
    goto label$11_end_710;
label$12_end_711:
    call push(arg1);
    call popToTmp1();
    idx := (real_to_int($tmp1)) + (4);
