...
procedure {:inline 1} assembly_index_init();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies global_1;
modifies global_2;
implementation assembly_index_init()
{
    var arg1: real;
    var arg2: real;
    var loc1: real;
...
procedure {:inline 1} assembly_index_step();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
modifies $stack;
modifies $mem;
implementation assembly_index_step()
{
    var loc1: real;
    var loc2: real;
    var loc3: real;
...
label$7_start_40:
    ...
    if (real_to_bool($tmp1)) {
        ...
        call push(($tmp2) + ($tmp1));
        call loc1 := popArgs1();
        goto label$7_start_40;
    }
}

procedure {:inline 1} CorralChoice__4cb774a0df85b077924b1181fff94a92592fea64b3ada6539662fc6bea9475ea();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies global_1;
modifies global_2;
implementation CorralChoice__4cb774a0df85b077924b1181fff94a92592fea64b3ada6539662fc6bea9475ea()
{
    var c: int;
    var argTmp: real;
    havoc c;
    ...
    if ((c) == (0)) {
        ...
        assume ((argTmp) == (real(int(argTmp))));
        call push(argTmp);
        call assembly_index_init();
    } else if ((c) == (1)) {
        call assembly_index_step();
    } else if ((c) == (2)) {
        havoc argTmp;
        assume ((argTmp) == (real(int(argTmp))));
        call push(argTmp);
...
procedure BoogieEntry__4cb774a0df85b077924b1181fff94a92592fea64b3ada6539662fc6bea9475ea();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies global_1;
modifies global_2;
implementation BoogieEntry__4cb774a0df85b077924b1181fff94a92592fea64b3ada6539662fc6bea9475ea()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry__4cb774a0df85b077924b1181fff94a92592fea64b3ada6539662fc6bea9475ea();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies global_1;
modifies global_2;
implementation CorralEntry__4cb774a0df85b077924b1181fff94a92592fea64b3ada6539662fc6bea9475ea()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice__4cb774a0df85b077924b1181fff94a92592fea64b3ada6539662fc6bea9475ea();
    }
}
