...
label$6_start_1335:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$6_start_1335;
    }
    // // unhandled raw instruction: i32.and
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$7_end_1337;
    }
    call push(loc1);
    call push(arg1);
    call popToTmp1();
...
label$3_end_1675:
    ...
    idx := real_to_int($tmp1);
    if (((idx) < (0)) || ((idx) >= (3))) {
        goto label$7_end_1680;
    } else {
        if ((idx) == (0)) {
            goto label$7_end_1680;
        }
        if ((idx) == (1)) {
            goto label$6_end_1679;
        }
        if ((idx) == (2)) {
            goto label$5_end_1678;
        }
        goto label$7_end_1680;
    }
label$7_end_1680:
