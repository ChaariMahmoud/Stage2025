...
modifies global_5;
ensures((global_5) == (128.0));
implementation initGlobals()
{
    global_5 := 128.0;
}

procedure {:inline 1} args_get();
modifies $tmp1;
modifies $sp;
modifies $stack;
implementation args_get()
{
}

procedure {:inline 1} args_sizes_get();
modifies $tmp1;
modifies $sp;
modifies $stack;
implementation args_sizes_get()
{
}
...
procedure {:inline 1} proc_exit();
modifies $tmp1;
modifies $sp;
modifies $stack;
implementation proc_exit()
{
}
...
procedure {:inline 1} CorralChoice__567b5b3ab0c762bafcc4f0caf7f4f8a1941fa6ebc87146135720fd93db30db35();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_5;
implementation CorralChoice__567b5b3ab0c762bafcc4f0caf7f4f8a1941fa6ebc87146135720fd93db30db35()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry__567b5b3ab0c762bafcc4f0caf7f4f8a1941fa6ebc87146135720fd93db30db35();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_5;
implementation BoogieEntry__567b5b3ab0c762bafcc4f0caf7f4f8a1941fa6ebc87146135720fd93db30db35()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry__567b5b3ab0c762bafcc4f0caf7f4f8a1941fa6ebc87146135720fd93db30db35();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_5;
implementation CorralEntry__567b5b3ab0c762bafcc4f0caf7f4f8a1941fa6ebc87146135720fd93db30db35()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice__567b5b3ab0c762bafcc4f0caf7f4f8a1941fa6ebc87146135720fd93db30db35();
    }
}
