...
axiom((global_1) == (65608.0));
const global_2: real;

axiom((global_2) == (65536.0));
const global_3: real;

axiom((global_3) == (65608.0));
const global_4: real;

axiom((global_4) == (65536.0));
const global_5: real;
...
procedure {:inline 1} host_func();
modifies $tmp1;
modifies $sp;
modifies $stack;
implementation host_func()
{
}
...
procedure {:inline 1} runtime_scheduler();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation runtime_scheduler()
{
    var loc1: real;
    var entry_sp: int;
    var idx: int;
...
procedure {:inline 1} go_scheduler();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
procedure {:inline 1} runtime_nilPanic();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation runtime_nilPanic()
{
    var entry_sp: int;
    var idx: int;
    var load_i: int;
    var store_i: int;
    entry_sp := $sp;
    call runtime_runtimePanic();
    assume (false);
}

procedure {:inline 1} runtime_runtimePanic();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation runtime_runtimePanic()
{
    var entry_sp: int;
    var idx: int;
    var load_i: int;
    ...
    call push(23.0);
    call runtime_printstring();
    call runtime_printnl();
    assume (false);
}

procedure {:inline 1} runtime_printnl();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem_pages;
modifies global_0;
implementation runtime_printnl()
{
    var loc1: real;
    var entry_sp: int;
    var idx: int;
...
procedure {:inline 1} runtime_printstring();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem_pages;
modifies global_0;
implementation runtime_printstring()
{
    var arg1: real;
    var arg2: real;
    var loc1: real;
...
implementation resume()
{
    ...
    var store_i: int;
    entry_sp := $sp;
    call runtime_resume_1();
    assume (false);
}

procedure {:inline 1} runtime_resume_1();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation runtime_resume_1()
{
    var entry_sp: int;
    var idx: int;
    var load_i: int;
    var store_i: int;
    entry_sp := $sp;
    call runtime_nilPanic();
    assume (false);
}

procedure {:inline 1} call_host_func();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
procedure {:inline 1} host_func_go_main();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation host_func_go_main()
{
    var arg1: real;
    var arg2: real;
    var entry_sp: int;
...
procedure {:inline 1} CorralChoice__5982ffbbe5eb320cd1b9b199996ef58e26a513d70bf2590e71a8ca8314165372();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem_pages;
modifies global_0;
implementation CorralChoice__5982ffbbe5eb320cd1b9b199996ef58e26a513d70bf2590e71a8ca8314165372()
{
    var c: int;
    var argTmp: real;
    havoc c;
    ...
    if ((c) == (0)) {
        ...
        assume ((argTmp) == (real(int(argTmp))));
        call push(argTmp);
        call host_func_go_main();
    }
}

procedure BoogieEntry__5982ffbbe5eb320cd1b9b199996ef58e26a513d70bf2590e71a8ca8314165372();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem_pages;
modifies global_0;
implementation BoogieEntry__5982ffbbe5eb320cd1b9b199996ef58e26a513d70bf2590e71a8ca8314165372()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry__5982ffbbe5eb320cd1b9b199996ef58e26a513d70bf2590e71a8ca8314165372();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem_pages;
modifies global_0;
implementation CorralEntry__5982ffbbe5eb320cd1b9b199996ef58e26a513d70bf2590e71a8ca8314165372()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice__5982ffbbe5eb320cd1b9b199996ef58e26a513d70bf2590e71a8ca8314165372();
    }
}
