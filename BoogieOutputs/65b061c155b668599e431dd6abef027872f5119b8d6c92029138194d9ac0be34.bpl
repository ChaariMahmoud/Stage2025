...
procedure {:inline 1} callDelegate();
modifies $tmp1;
modifies $sp;
modifies $stack;
...
procedure {:inline 1} callStatic();
modifies $tmp1;
modifies $sp;
modifies $stack;
implementation callStatic()
{
}

procedure {:inline 1} getGasLeft();
modifies $tmp1;
modifies $sp;
modifies $stack;
implementation getGasLeft()
{
}

procedure {:inline 1} getBlockGasLimit();
modifies $tmp1;
modifies $sp;
modifies $stack;
implementation getBlockGasLimit()
{
}

procedure {:inline 1} getBlockNumber();
modifies $tmp1;
modifies $sp;
modifies $stack;
implementation getBlockNumber()
{
}

procedure {:inline 1} getBlockHash();
modifies $tmp1;
modifies $sp;
modifies $stack;
implementation getBlockHash()
{
}
...
procedure {:inline 1} CorralChoice__65b061c155b668599e431dd6abef027872f5119b8d6c92029138194d9ac0be34();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation CorralChoice__65b061c155b668599e431dd6abef027872f5119b8d6c92029138194d9ac0be34()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry__65b061c155b668599e431dd6abef027872f5119b8d6c92029138194d9ac0be34();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation BoogieEntry__65b061c155b668599e431dd6abef027872f5119b8d6c92029138194d9ac0be34()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry__65b061c155b668599e431dd6abef027872f5119b8d6c92029138194d9ac0be34();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation CorralEntry__65b061c155b668599e431dd6abef027872f5119b8d6c92029138194d9ac0be34()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice__65b061c155b668599e431dd6abef027872f5119b8d6c92029138194d9ac0be34();
    }
}
