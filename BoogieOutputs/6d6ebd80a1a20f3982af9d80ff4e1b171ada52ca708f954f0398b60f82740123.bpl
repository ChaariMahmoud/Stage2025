...
axiom((global_4) == (176.0));
const global_5: real;

axiom((global_5) == (204.0));
...
procedure {:inline 1} assembly_index_add();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation assembly_index_add()
{
    var arg1: real;
    var arg2: real;
    var entry_sp: int;
...
procedure {:inline 1} _lib_rt_pure_finalize();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation _lib_rt_pure_finalize()
{
    var arg1: real;
    var entry_sp: int;
    var idx: int;
...
procedure {:inline 1} CorralChoice__6d6ebd80a1a20f3982af9d80ff4e1b171ada52ca708f954f0398b60f82740123();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies global_2;
modifies global_3;
implementation CorralChoice__6d6ebd80a1a20f3982af9d80ff4e1b171ada52ca708f954f0398b60f82740123()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry__6d6ebd80a1a20f3982af9d80ff4e1b171ada52ca708f954f0398b60f82740123();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies global_2;
modifies global_3;
implementation BoogieEntry__6d6ebd80a1a20f3982af9d80ff4e1b171ada52ca708f954f0398b60f82740123()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry__6d6ebd80a1a20f3982af9d80ff4e1b171ada52ca708f954f0398b60f82740123();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies global_2;
modifies global_3;
implementation CorralEntry__6d6ebd80a1a20f3982af9d80ff4e1b171ada52ca708f954f0398b60f82740123()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice__6d6ebd80a1a20f3982af9d80ff4e1b171ada52ca708f954f0398b60f82740123();
    }
}
