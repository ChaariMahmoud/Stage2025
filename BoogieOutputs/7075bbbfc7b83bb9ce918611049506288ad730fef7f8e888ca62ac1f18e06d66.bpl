...
axiom((global_1) == (17220.0));
const global_2: real;

axiom((global_2) == (17220.0));
...
label$27_end_28:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$21_end_22;
    }
    call push(0.0);
    call push(8464.0);
    call fimport_3();
    goto label$20_end_21;
label$26_end_27:
    call push(arg3);
    call push(500.0);
    call popToTmp1();
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$19_end_20;
    }
    call push(0.0);
    call push(8464.0);
    call fimport_3();
    goto label$18_end_19;
label$25_end_26:
    call push(arg3);
    call push(250.0);
    call popToTmp1();
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$17_end_18;
    }
    call push(0.0);
    call push(8464.0);
    call fimport_3();
    goto label$16_end_17;
label$24_end_25:
    call push(arg4);
    call popToTmp1();
    call push(bool_to_real(($tmp1) == (0.0)));
...
label$22_end_23:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$15_end_16;
    }
    call push(0.0);
    call push(8464.0);
    call fimport_3();
    goto label$14_end_15;
label$21_end_22:
    call push(arg4);
    call popToTmp1();
    call push(bool_to_real(($tmp1) == (0.0)));
...
label$44_end_78:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$51_end_90;
    }
    goto label$50_end_89;
label$52_end_91:
    call push(arg4);
    call push(16.0);
    call popToTmp1();
...
label$59_start_105:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$59_start_105;
    }
    goto label$57_end_103;
label$60_end_107:
    call push(loc7);
    call loc6 := popArgs1();
label$61_start_109:
...
label$57_end_103:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$65_end_116;
    }
    goto label$64_end_115;
label$66_end_117:
    call push(loc8);
...
label$71_start_125:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$71_start_125;
    }
    goto label$69_end_123;
label$72_end_127:
    call push(loc7);
    call loc6 := popArgs1();
label$73_start_129:
...
label$69_end_123:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$77_end_136;
    }
    goto label$76_end_135;
label$78_end_137:
    call push(arg4);
    call push(16.0);
    call popToTmp1();
...
label$81_end_144:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$83_end_148;
    }
    goto label$82_end_147;
label$84_end_149:
    call push(arg4);
    call push(16.0);
    call popToTmp1();
...
label$93_start_167:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$93_start_167;
    }
    goto label$91_end_165;
label$94_end_169:
    call push(loc7);
    call loc6 := popArgs1();
label$95_start_171:
...
label$91_end_165:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$99_end_178;
    }
    goto label$98_end_177;
label$100_end_179:
    call push(loc8);
    // // numeric cast i64.trunc_f32_s: no-op under real semantics
    call loc10 := popArgs1();
...
label$105_start_187:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$105_start_187;
    }
    goto label$103_end_185;
label$106_end_189:
    call push(loc7);
    call loc6 := popArgs1();
label$107_start_191:
...
label$103_end_185:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$111_end_198;
    }
    goto label$110_end_197;
label$112_end_199:
    call push(arg4);
    call push(16.0);
    call popToTmp1();
...
label$115_end_206:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$117_end_210;
    }
    goto label$116_end_209;
label$118_end_211:
    call push(arg4);
    call push(16.0);
    call popToTmp1();
...
label$127_start_229:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$127_start_229;
    }
    goto label$125_end_227;
label$128_end_231:
    call push(loc7);
    call loc6 := popArgs1();
label$129_start_233:
...
label$125_end_227:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$133_end_240;
    }
    goto label$132_end_239;
label$134_end_241:
    call push(loc8);
    // // numeric cast i64.trunc_f32_s: no-op under real semantics
    call loc10 := popArgs1();
...
label$139_start_249:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$139_start_249;
    }
    goto label$137_end_247;
label$140_end_251:
    call push(loc7);
    call loc6 := popArgs1();
label$141_start_253:
...
label$137_end_247:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$145_end_260;
    }
    goto label$144_end_259;
label$146_end_261:
    call push(arg4);
    call push(16.0);
    call popToTmp1();
...
label$149_end_268:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$151_end_272;
    }
    goto label$150_end_271;
label$152_end_273:
    call push(arg4);
    call push(16.0);
    call popToTmp1();
...
label$161_start_291:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$161_start_291;
    }
    goto label$159_end_289;
label$162_end_293:
    call push(loc7);
    call loc6 := popArgs1();
label$163_start_295:
...
label$159_end_289:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$167_end_302;
    }
    goto label$166_end_301;
label$168_end_303:
    call push(loc8);
    // // numeric cast i64.trunc_f32_s: no-op under real semantics
    call loc10 := popArgs1();
...
label$173_start_311:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$173_start_311;
    }
    goto label$171_end_309;
label$174_end_313:
    call push(loc7);
    call loc6 := popArgs1();
label$175_start_315:
...
label$171_end_309:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$177_end_320;
    }
    goto label$176_end_319;
label$178_end_321:
    call push(arg4);
    call push(16.0);
    call popToTmp1();
...
label$181_end_328:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$183_end_332;
    }
    goto label$182_end_331;
label$184_end_333:
    call push(arg4);
    call push(16.0);
    call popToTmp1();
...
procedure {:inline 1} CorralChoice__7075bbbfc7b83bb9ce918611049506288ad730fef7f8e888ca62ac1f18e06d66();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem_pages;
modifies global_0;
implementation CorralChoice__7075bbbfc7b83bb9ce918611049506288ad730fef7f8e888ca62ac1f18e06d66()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry__7075bbbfc7b83bb9ce918611049506288ad730fef7f8e888ca62ac1f18e06d66();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem_pages;
modifies global_0;
implementation BoogieEntry__7075bbbfc7b83bb9ce918611049506288ad730fef7f8e888ca62ac1f18e06d66()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry__7075bbbfc7b83bb9ce918611049506288ad730fef7f8e888ca62ac1f18e06d66();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem_pages;
modifies global_0;
implementation CorralEntry__7075bbbfc7b83bb9ce918611049506288ad730fef7f8e888ca62ac1f18e06d66()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice__7075bbbfc7b83bb9ce918611049506288ad730fef7f8e888ca62ac1f18e06d66();
    }
}
