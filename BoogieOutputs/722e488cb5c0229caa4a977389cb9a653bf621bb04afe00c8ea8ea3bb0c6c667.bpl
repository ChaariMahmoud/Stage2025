...
axiom((global_1) == (9019.0));
const global_2: real;

axiom((global_2) == (9019.0));
...
label$35_start_195:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$35_start_195;
    }
    goto label$33_end_193;
label$36_end_197:
    call push(arg3);
    call arg2 := popArgs1();
label$37_start_199:
...
label$33_end_193:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$39_end_204;
    }
    goto label$38_end_203;
label$40_end_205:
    call push(loc1);
    call push(280.0);
    call popToTmp1();
...
label$43_start_211:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$43_start_211;
    }
    goto label$41_end_209;
label$44_end_213:
    call push(arg3);
    call arg2 := popArgs1();
label$45_start_215:
...
label$55_start_237:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$55_start_237;
    }
    goto label$56_end_239;
label$57_end_240:
    call push(arg3);
    call arg2 := popArgs1();
label$58_start_242:
...
label$25_end_182:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$71_end_258;
    }
    goto label$70_end_257;
label$72_end_259:
    call push(loc3);
    call push(16.0);
    call popToTmp1();
...
label$70_end_257:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$74_end_267;
    }
    goto label$73_end_266;
label$75_end_268:
    call push(loc3);
    call push(16.0);
    call popToTmp1();
...
label$73_end_266:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$76_end_275;
    }
    goto label$67_end_253;
label$77_end_276:
    call push(0.0);
    call push(loc1);
    call popToTmp1();
...
label$64_end_250:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$62_end_248;
    }
    goto label$61_end_247;
label$63_end_249:
    call push(loc1);
    call popToTmp1();
    idx := (real_to_int($tmp1)) + (400);
...
label$62_end_248:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$60_end_246;
    }
    goto label$59_end_245;
label$61_end_247:
    call push(loc1);
    call popToTmp1();
    idx := (real_to_int($tmp1)) + (408);
...
label$80_start_280:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$80_start_280;
    }
    goto label$78_end_278;
label$81_end_282:
    call push(arg3);
    call arg2 := popArgs1();
label$82_start_284:
...
label$84_end_289:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$96_end_309;
    }
    goto label$95_end_308;
label$97_end_310:
    call push(loc6);
    call push(loc3);
    call push(16.0);
...
label$108_end_344:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$109_end_346;
    }
    goto label$93_end_304;
label$110_end_347:
    call push(loc1);
    call push(64.0);
    call popToTmp1();
...
label$59_end_245:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$113_end_350;
    }
    goto label$112_end_349;
label$114_end_351:
    call push(loc1);
    call push(328.0);
    call popToTmp1();
...
procedure {:inline 1} CorralChoice__722e488cb5c0229caa4a977389cb9a653bf621bb04afe00c8ea8ea3bb0c6c667();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem_pages;
modifies global_0;
implementation CorralChoice__722e488cb5c0229caa4a977389cb9a653bf621bb04afe00c8ea8ea3bb0c6c667()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry__722e488cb5c0229caa4a977389cb9a653bf621bb04afe00c8ea8ea3bb0c6c667();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem_pages;
modifies global_0;
implementation BoogieEntry__722e488cb5c0229caa4a977389cb9a653bf621bb04afe00c8ea8ea3bb0c6c667()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry__722e488cb5c0229caa4a977389cb9a653bf621bb04afe00c8ea8ea3bb0c6c667();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem_pages;
modifies global_0;
implementation CorralEntry__722e488cb5c0229caa4a977389cb9a653bf621bb04afe00c8ea8ea3bb0c6c667()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice__722e488cb5c0229caa4a977389cb9a653bf621bb04afe00c8ea8ea3bb0c6c667();
    }
}
