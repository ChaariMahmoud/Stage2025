...
label$18_start_787:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$19_end_789;
    }
    goto label$18_start_787;
label$20_end_790:
    call push(loc2);
    call push(loc3);
    call push(1.0);
...
label$21_end_794:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$13_end_782;
    }
    goto label$14_end_783;
label$17_end_786:
    call func_52();
    call push(22.0);
    call popToTmp2();
...
label$25_start_811:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$26_end_813;
    }
    goto label$24_end_810;
label$27_end_814:
    call push(loc3);
    call push(loc1);
    call popToTmp1();
...
label$35_start_840:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$36_end_842;
    }
    goto label$34_end_839;
label$37_end_843:
    call push(arg1);
    call func_57();
    call loc3 := popArgs1();
...
label$43_start_859:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$44_end_861;
    }
    goto label$42_end_858;
label$45_end_862:
    call push(arg1);
    call func_57();
    call loc3 := popArgs1();
...
label$50_start_875:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$50_start_875;
    }
    goto label$49_end_874;
label$51_end_877:
    call push(arg2);
    call push(arg1);
    call func_57();
...
label$52_end_879:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$53_end_881;
    }
    // // unhandled raw instruction: i64.and
    // // wrap: no-op under real semantics
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$54_end_882;
    }
    call push(loc4);
    call popToTmp1();
    if (real_to_bool($tmp1)) {
