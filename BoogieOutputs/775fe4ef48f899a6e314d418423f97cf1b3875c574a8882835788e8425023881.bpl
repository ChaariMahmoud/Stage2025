...
label$31_end_1548:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$34_end_1552;
    }
    call push(loc8);
    call loc6 := popArgs1();
    goto label$33_end_1551;
label$34_end_1552:
    call push(loc9);
    call push(loc1);
    // // unhandled raw instruction: i32.shl
