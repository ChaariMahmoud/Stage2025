...
axiom((global_1) == (1048708.0));
const global_2: real;

axiom((global_2) == (1048708.0));
...
label$1_end_1:
    ...
    call push(loc12);
    call push(loc14);
    call _ZN4core9panicking5panic17haaa3308f42d56d56E();
    assume (false);
func_exit_3:
}
...
procedure {:inline 1} _ZN4core3ptr13drop_in_place17h002d819e129d39acE();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
modifies $stack;
modifies $mem;
implementation _ZN4core3ptr13drop_in_place17h002d819e129d39acE()
{
    var arg1: real;
    var entry_sp: int;
    var idx: int;
...
procedure {:inline 1} _ZN4core9panicking5panic17haaa3308f42d56d56E();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation _ZN4core9panicking5panic17haaa3308f42d56d56E()
{
    var arg1: real;
    var arg2: real;
    var arg3: real;
    ...
    call push(loc1);
    call push(arg3);
    call _ZN4core9panicking9panic_fmt17hcfe6c791574cdfcbE();
    assume (false);
}

procedure {:inline 1} _ZN4core9panicking9panic_fmt17hcfe6c791574cdfcbE();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation _ZN4core9panicking9panic_fmt17hcfe6c791574cdfcbE()
{
    var arg1: real;
    var arg2: real;
    var loc1: real;
...
procedure {:inline 1} _ZN36__LT_T_u20_as_u20_core__any__Any_GT_7type_id17h109d9c689c3f6708E();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
modifies $stack;
modifies $mem;
implementation _ZN36__LT_T_u20_as_u20_core__any__Any_GT_7type_id17h109d9c689c3f6708E()
{
    var arg1: real;
    var entry_sp: int;
    var idx: int;
...
procedure {:inline 1} CorralChoice__80f796c269a73bc2a3c48ab80b23ad30957fde01148f9eb9086aa0a3d04523ba();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation CorralChoice__80f796c269a73bc2a3c48ab80b23ad30957fde01148f9eb9086aa0a3d04523ba()
{
    var c: int;
    var argTmp: real;
    havoc c;
    ...
    if ((c) == (0)) {
        ...
        assume ((argTmp) == (real(int(argTmp))));
        call push(argTmp);
        call _ZN4core3ptr13drop_in_place17h002d819e129d39acE();
    } else if ((c) == (3)) {
        havoc argTmp;
        assume ((argTmp) == (real(int(argTmp))));
        call push(argTmp);
        ...
        assume ((argTmp) == (real(int(argTmp))));
        call push(argTmp);
        call _ZN36__LT_T_u20_as_u20_core__any__Any_GT_7type_id17h109d9c689c3f6708E();
        call popDiscard1();
    }
}

procedure BoogieEntry__80f796c269a73bc2a3c48ab80b23ad30957fde01148f9eb9086aa0a3d04523ba();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation BoogieEntry__80f796c269a73bc2a3c48ab80b23ad30957fde01148f9eb9086aa0a3d04523ba()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry__80f796c269a73bc2a3c48ab80b23ad30957fde01148f9eb9086aa0a3d04523ba();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation CorralEntry__80f796c269a73bc2a3c48ab80b23ad30957fde01148f9eb9086aa0a3d04523ba()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice__80f796c269a73bc2a3c48ab80b23ad30957fde01148f9eb9086aa0a3d04523ba();
    }
}
