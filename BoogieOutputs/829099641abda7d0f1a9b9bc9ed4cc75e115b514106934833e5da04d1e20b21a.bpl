...
label$14_end_1466:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$13_start_1464;
    }
label$12_end_1463:
    // // unhandled raw instruction: i32.and
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$11_start_1461;
    }
    // // unhandled raw instruction: i32.and
    call popToTmp1();
    if (real_to_bool($tmp1)) {
