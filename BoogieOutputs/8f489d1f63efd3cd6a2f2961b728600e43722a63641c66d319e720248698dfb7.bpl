...
axiom((global_1) == (66864.0));
const global_2: real;

axiom((global_2) == (1327.0));
const global_3: real;
...
procedure {:inline 1} initTryPerm();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
procedure {:inline 1} isAdditionChain();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
modifies $stack;
modifies $mem;
implementation isAdditionChain()
{
    var arg1: real;
    var arg2: real;
    var loc1: real;
...
label$16_start_94:
    ...
    idx := real_to_int($tmp1);
    if (((idx) < (0)) || ((idx) >= (4))) {
        goto label$20_end_99;
    } else {
        if ((idx) == (0)) {
            goto label$23_end_102;
        }
        if ((idx) == (1)) {
            goto label$22_end_101;
        }
        if ((idx) == (2)) {
            goto label$21_end_100;
        }
        if ((idx) == (3)) {
            goto label$20_end_99;
        }
...
procedure {:inline 1} findNonBrauer();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
procedure {:inline 1} CorralChoice__8f489d1f63efd3cd6a2f2961b728600e43722a63641c66d319e720248698dfb7();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation CorralChoice__8f489d1f63efd3cd6a2f2961b728600e43722a63641c66d319e720248698dfb7()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry__8f489d1f63efd3cd6a2f2961b728600e43722a63641c66d319e720248698dfb7();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation BoogieEntry__8f489d1f63efd3cd6a2f2961b728600e43722a63641c66d319e720248698dfb7()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry__8f489d1f63efd3cd6a2f2961b728600e43722a63641c66d319e720248698dfb7();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation CorralEntry__8f489d1f63efd3cd6a2f2961b728600e43722a63641c66d319e720248698dfb7()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice__8f489d1f63efd3cd6a2f2961b728600e43722a63641c66d319e720248698dfb7();
    }
}
