...
label$16_start_98:
    ...
    idx := real_to_int($tmp1);
    if (((idx) < (0)) || ((idx) >= (4))) {
        goto label$20_end_103;
    } else {
        if ((idx) == (0)) {
            goto label$23_end_106;
        }
        if ((idx) == (1)) {
            goto label$22_end_105;
        }
        if ((idx) == (2)) {
            goto label$21_end_104;
        }
        if ((idx) == (3)) {
            goto label$20_end_103;
        }
...
label$29_start_118:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$29_start_118;
    }
    goto label$27_end_116;
label$28_end_117:
    call push(loc47);
    call push(loc30);
    call popToTmp1();
