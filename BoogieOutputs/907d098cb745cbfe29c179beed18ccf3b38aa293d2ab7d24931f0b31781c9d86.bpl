...
procedure {:inline 1} __fixunsdfti();
modifies $tmp1;
modifies $sp;
modifies $stack;
implementation __fixunsdfti()
{
}

procedure {:inline 1} __floatuntidf();
modifies $tmp1;
modifies $sp;
modifies $stack;
implementation __floatuntidf()
{
}
...
label$12_end_886:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$11_start_884;
    }
    goto label$9_end_882;
label$10_end_883:
    call push(0.0);
    call loc5 := popArgs1();
label$9_end_882:
...
label$19_end_897:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$16_end_894;
    }
    goto label$15_end_893;
label$18_end_896:
    call push(loc5);
    call push(208.0);
    call popToTmp1();
...
label$25_end_905:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$22_end_902;
    }
    goto label$21_end_901;
label$24_end_904:
    call push(loc5);
    call push(208.0);
    call popToTmp1();
...
label$31_end_913:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$28_end_910;
    }
    goto label$27_end_909;
label$30_end_912:
    call push(loc5);
    call push(208.0);
    call popToTmp1();
...
label$27_end_909:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$34_end_918;
    }
    goto label$33_end_917;
label$35_end_919:
    // // unhandled raw instruction: i32.and
    call loc12 := popArgs1();
    call push(loc12);
...
implementation func_68()
{
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$2_end_1169;
    }
    call push(0.0);
    call popToTmp1();
    idx := (real_to_int($tmp1)) + (10104);
    call load_i := mem_read_s32(idx);
    call push(int_to_real(load_i));
    call loc7 := popArgs1();
    goto label$1_end_1168;
label$2_end_1169:
    call popToTmp1();
    idx := (real_to_int($tmp1)) + (0);
...
implementation func_69()
{
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$2_end_1207;
    }
    call push(0.0);
    call popToTmp1();
    idx := (real_to_int($tmp1)) + (9992);
    call load_i := mem_read_s32(idx);
    call push(int_to_real(load_i));
    call loc2 := popArgs1();
    call push(loc2);
...
label$4_end_1272:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$7_end_1277;
    }
    // // unhandled raw instruction: i32.and
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$6_end_1276;
    }
    call push(arg1);
    call push(1.0);
    call popToTmp1();
...
label$55_end_1505:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$56_end_1507;
    }
    // // unhandled raw instruction: i64.and
    // // wrap: no-op under real semantics
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$57_end_1508;
    }
    call push(loc1);
    call popToTmp1();
    if (real_to_bool($tmp1)) {
...
procedure {:inline 1} CorralChoice__907d098cb745cbfe29c179beed18ccf3b38aa293d2ab7d24931f0b31781c9d86();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
modifies $stack;
modifies $mem;
implementation CorralChoice__907d098cb745cbfe29c179beed18ccf3b38aa293d2ab7d24931f0b31781c9d86()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry__907d098cb745cbfe29c179beed18ccf3b38aa293d2ab7d24931f0b31781c9d86();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
modifies $stack;
modifies $mem;
implementation BoogieEntry__907d098cb745cbfe29c179beed18ccf3b38aa293d2ab7d24931f0b31781c9d86()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry__907d098cb745cbfe29c179beed18ccf3b38aa293d2ab7d24931f0b31781c9d86();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
modifies $stack;
modifies $mem;
implementation CorralEntry__907d098cb745cbfe29c179beed18ccf3b38aa293d2ab7d24931f0b31781c9d86()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice__907d098cb745cbfe29c179beed18ccf3b38aa293d2ab7d24931f0b31781c9d86();
    }
}
