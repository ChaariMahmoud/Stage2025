...
label$49_end_108:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$56_end_117;
    }
    goto label$55_end_116;
label$57_end_118:
    // // unhandled raw instruction: i32.and
    call loc4 := popArgs1();
    call push(loc4);
