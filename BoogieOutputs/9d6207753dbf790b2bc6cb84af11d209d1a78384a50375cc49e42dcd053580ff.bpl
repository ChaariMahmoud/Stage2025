...
label$18_end_65:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$15_end_62;
    }
    goto label$14_end_61;
label$17_end_64:
    call push(loc1);
    call push(208.0);
    call popToTmp1();
...
label$36_end_99:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$35_start_97;
    }
    goto label$33_end_95;
label$34_end_96:
    call push(0.0);
    call loc1 := popArgs1();
label$33_end_95:
...
label$43_end_112:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$40_end_109;
    }
    goto label$39_end_108;
label$42_end_111:
    call push(loc1);
    call push(208.0);
    call popToTmp1();
...
label$49_end_124:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$56_end_134;
    }
    goto label$55_end_133;
label$57_end_135:
    call push(loc5);
    call push(16.0);
    call popToTmp1();
...
procedure {:inline 1} CorralChoice__9d6207753dbf790b2bc6cb84af11d209d1a78384a50375cc49e42dcd053580ff();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation CorralChoice__9d6207753dbf790b2bc6cb84af11d209d1a78384a50375cc49e42dcd053580ff()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry__9d6207753dbf790b2bc6cb84af11d209d1a78384a50375cc49e42dcd053580ff();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation BoogieEntry__9d6207753dbf790b2bc6cb84af11d209d1a78384a50375cc49e42dcd053580ff()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry__9d6207753dbf790b2bc6cb84af11d209d1a78384a50375cc49e42dcd053580ff();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation CorralEntry__9d6207753dbf790b2bc6cb84af11d209d1a78384a50375cc49e42dcd053580ff()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice__9d6207753dbf790b2bc6cb84af11d209d1a78384a50375cc49e42dcd053580ff();
    }
}
