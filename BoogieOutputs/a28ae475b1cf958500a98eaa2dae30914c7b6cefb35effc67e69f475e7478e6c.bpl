...
modifies global_5;
ensures(($mem_pages) == (0));
ensures((global_0) == (512.0));
ensures((global_1) == (512.0));
ensures((global_2) == (262144.0));
ensures((global_3) == (1370720.0));
ensures((global_4) == (2359296.0));
ensures((global_5) == (2361344.0));
...
procedure {:inline 1} CorralChoice_a28ae475b1cf958500a98eaa2dae30914c7b6cefb35effc67e69f475e7478e6c();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies global_4;
modifies global_5;
implementation CorralChoice_a28ae475b1cf958500a98eaa2dae30914c7b6cefb35effc67e69f475e7478e6c()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry_a28ae475b1cf958500a98eaa2dae30914c7b6cefb35effc67e69f475e7478e6c();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies global_4;
modifies global_5;
implementation BoogieEntry_a28ae475b1cf958500a98eaa2dae30914c7b6cefb35effc67e69f475e7478e6c()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry_a28ae475b1cf958500a98eaa2dae30914c7b6cefb35effc67e69f475e7478e6c();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies global_4;
modifies global_5;
implementation CorralEntry_a28ae475b1cf958500a98eaa2dae30914c7b6cefb35effc67e69f475e7478e6c()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice_a28ae475b1cf958500a98eaa2dae30914c7b6cefb35effc67e69f475e7478e6c();
    }
}
