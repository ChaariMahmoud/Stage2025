...
procedure {:inline 1} CorralChoice_a6d47d455ddf60bdf8f222d40160ce6c670abe528262ccbc69094759a944d341();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
modifies $stack;
modifies $mem;
implementation CorralChoice_a6d47d455ddf60bdf8f222d40160ce6c670abe528262ccbc69094759a944d341()
{
    var c: int;
    havoc c;
    assume (((0) <= (c)) && ((c) < (1)));
...
procedure BoogieEntry_a6d47d455ddf60bdf8f222d40160ce6c670abe528262ccbc69094759a944d341();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
modifies $stack;
modifies $mem;
implementation BoogieEntry_a6d47d455ddf60bdf8f222d40160ce6c670abe528262ccbc69094759a944d341()
{
    var c: int;
    call initGlobals();
    call InitRuntime();
...
procedure CorralEntry_a6d47d455ddf60bdf8f222d40160ce6c670abe528262ccbc69094759a944d341();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
modifies $stack;
modifies $mem;
implementation CorralEntry_a6d47d455ddf60bdf8f222d40160ce6c670abe528262ccbc69094759a944d341()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice_a6d47d455ddf60bdf8f222d40160ce6c670abe528262ccbc69094759a944d341();
    }
}
