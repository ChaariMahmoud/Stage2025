...
axiom((global_11) == (10160.0));
const global_12: real;

axiom((global_12) == (10188.0));
...
procedure {:inline 1} start_assembly_index_anonymous_0();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation start_assembly_index_anonymous_0()
{
    var arg1: real;
    var arg2: real;
    var entry_sp: int;
...
procedure {:inline 1} _setArgumentsLength();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem_pages;
modifies global_10;
implementation _setArgumentsLength()
{
    var arg1: real;
    var entry_sp: int;
    var idx: int;
...
procedure {:inline 1} assembly_index_compute();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem_pages;
modifies global_10;
implementation assembly_index_compute()
{
    var arg1: real;
    var arg2: real;
    var loc1: real;
...
label$2_start_88:
    ...
    if (real_to_bool($tmp1)) {
        ...
        if (real_to_bool($tmp1)) {
            call push(arg2);
            // // numeric cast f32.convert_i32_u: no-op under real semantics
            call loc6 := popArgs1();
            call push(loc3);
            call push(loc6);
            call popToTmp1();
...
procedure {:inline 1} CorralChoice_a743067c4ea2b12c2fec542202a8b081a5a44b63602407e9c77e3543a4828afe();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies global_2;
modifies global_10;
implementation CorralChoice_a743067c4ea2b12c2fec542202a8b081a5a44b63602407e9c77e3543a4828afe()
{
    var c: int;
    var argTmp: real;
    havoc c;
    ...
    if ((c) == (0)) {
        ...
        assume ((argTmp) == (real(int(argTmp))));
        call push(argTmp);
        call start_assembly_index_anonymous_0();
        call popDiscard1();
    } else if ((c) == (14)) {
        havoc argTmp;
        assume ((argTmp) == (real(int(argTmp))));
        call push(argTmp);
        call _setArgumentsLength();
    } else if ((c) == (15)) {
        havoc argTmp;
        assume ((argTmp) == (real(int(argTmp))));
        call push(argTmp);
...
procedure BoogieEntry_a743067c4ea2b12c2fec542202a8b081a5a44b63602407e9c77e3543a4828afe();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies global_2;
modifies global_10;
implementation BoogieEntry_a743067c4ea2b12c2fec542202a8b081a5a44b63602407e9c77e3543a4828afe()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry_a743067c4ea2b12c2fec542202a8b081a5a44b63602407e9c77e3543a4828afe();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies global_2;
modifies global_10;
implementation CorralEntry_a743067c4ea2b12c2fec542202a8b081a5a44b63602407e9c77e3543a4828afe()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice_a743067c4ea2b12c2fec542202a8b081a5a44b63602407e9c77e3543a4828afe();
    }
}
