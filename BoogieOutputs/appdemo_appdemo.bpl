...
axiom((global_1) == (17430.0));
const global_2: real;

axiom((global_2) == (17430.0));
...
procedure {:inline 1} CorralChoice_appdemo_appdemo();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation CorralChoice_appdemo_appdemo()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry_appdemo_appdemo();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation BoogieEntry_appdemo_appdemo()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry_appdemo_appdemo();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation CorralEntry_appdemo_appdemo()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice_appdemo_appdemo();
    }
}
