...
axiom((global_1) == (17014.0));
const global_2: real;

axiom((global_2) == (17014.0));
...
procedure {:inline 1} CorralChoice_autoservice_autoservice();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation CorralChoice_autoservice_autoservice()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry_autoservice_autoservice();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation BoogieEntry_autoservice_autoservice()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry_autoservice_autoservice();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation CorralEntry_autoservice_autoservice()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice_autoservice_autoservice();
    }
}
