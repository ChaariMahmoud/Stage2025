...
procedure {:inline 1} bigIntSetInt64();
modifies $tmp1;
modifies $sp;
modifies $stack;
implementation bigIntSetInt64()
{
}

procedure {:inline 1} bigIntAdd();
modifies $tmp1;
modifies $sp;
modifies $stack;
implementation bigIntAdd()
{
}

procedure {:inline 1} signalError();
modifies $tmp1;
modifies $sp;
modifies $stack;
implementation signalError()
{
}

procedure {:inline 1} storageLoadLength();
modifies $tmp1;
modifies $sp;
modifies $stack;
implementation storageLoadLength()
{
}

procedure {:inline 1} storageLoad();
modifies $tmp1;
modifies $sp;
modifies $stack;
implementation storageLoad()
{
}

procedure {:inline 1} getNumArguments();
modifies $tmp1;
modifies $sp;
modifies $stack;
implementation getNumArguments()
{
}

procedure {:inline 1} int64getArgument();
modifies $tmp1;
modifies $sp;
modifies $stack;
implementation int64getArgument()
{
}

procedure {:inline 1} executeOnDestContext();
modifies $tmp1;
modifies $sp;
modifies $stack;
implementation executeOnDestContext()
{
}

procedure {:inline 1} bigIntStorageStoreUnsigned();
modifies $tmp1;
modifies $sp;
modifies $stack;
implementation bigIntStorageStoreUnsigned()
{
}
...
procedure {:inline 1} CorralChoice_b1401cef83afb0be62660cbfed575d33031f77d0cdc3783b86b5918107fc2994();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation CorralChoice_b1401cef83afb0be62660cbfed575d33031f77d0cdc3783b86b5918107fc2994()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry_b1401cef83afb0be62660cbfed575d33031f77d0cdc3783b86b5918107fc2994();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation BoogieEntry_b1401cef83afb0be62660cbfed575d33031f77d0cdc3783b86b5918107fc2994()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry_b1401cef83afb0be62660cbfed575d33031f77d0cdc3783b86b5918107fc2994();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation CorralEntry_b1401cef83afb0be62660cbfed575d33031f77d0cdc3783b86b5918107fc2994()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice_b1401cef83afb0be62660cbfed575d33031f77d0cdc3783b86b5918107fc2994();
    }
}
