...
axiom((global_1) == (17082.0));
const global_2: real;

axiom((global_2) == (17082.0));
...
procedure {:inline 1} CorralChoice_basics_basics();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation CorralChoice_basics_basics()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry_basics_basics();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation BoogieEntry_basics_basics()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry_basics_basics();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation CorralEntry_basics_basics()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice_basics_basics();
    }
}
