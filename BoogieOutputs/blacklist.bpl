...
label$31_end_38:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$34_end_42;
    }
    goto label$33_end_41;
label$34_end_42:
    call push(loc3);
    call popToTmp1();
    idx := (real_to_int($tmp1)) + (188);
