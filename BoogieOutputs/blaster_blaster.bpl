...
axiom((global_1) == (16706.0));
const global_2: real;

axiom((global_2) == (16706.0));
...
procedure {:inline 1} CorralChoice_blaster_blaster();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation CorralChoice_blaster_blaster()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry_blaster_blaster();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation BoogieEntry_blaster_blaster()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry_blaster_blaster();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation CorralEntry_blaster_blaster()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice_blaster_blaster();
    }
}
