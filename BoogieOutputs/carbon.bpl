...
axiom((global_1) == (1524.0));
const global_2: real;

axiom((global_2) == (1024.0));
const global_3: real;

axiom((global_3) == (67072.0));
const global_4: real;

axiom((global_4) == (1024.0));
procedure {:inline 1} initGlobals();
modifies global_0;
ensures((global_0) == (67072.0));
...
procedure {:inline 1} CorralChoice_carbon();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation CorralChoice_carbon()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
modifies $mem;
modifies global_0;
implementation BoogieEntry_carbon()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
modifies $mem;
modifies global_0;
implementation CorralEntry_carbon()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice_carbon();
    }
}
