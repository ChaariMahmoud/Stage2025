...
axiom((global_1) == (17168.0));
const global_2: real;

axiom((global_2) == (17168.0));
...
label$27_start_53:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$32_end_61;
    }
    goto label$31_end_60;
label$33_end_62:
    // // unhandled raw instruction: i32.and
    call loc4 := popArgs1();
    call push(loc4);
...
label$39_end_79:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$41_end_82;
    }
    // // unhandled raw instruction: i32.and
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$40_end_81;
    }
    goto label$29_end_57;
label$41_end_82:
    call push(loc1);
    call push(48.0);
    call popToTmp1();
...
label$18_end_213:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$15_end_210;
    }
    goto label$14_end_209;
label$17_end_212:
    call push(loc6);
    call push(-48.0);
    call popToTmp1();
...
label$25_end_222:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$22_end_219;
    }
    goto label$21_end_218;
label$24_end_221:
    call push(loc6);
    call push(-48.0);
    call popToTmp1();
...
procedure {:inline 1} CorralChoice_charity_charity();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation CorralChoice_charity_charity()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry_charity_charity();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation BoogieEntry_charity_charity()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry_charity_charity();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation CorralEntry_charity_charity()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice_charity_charity();
    }
}
