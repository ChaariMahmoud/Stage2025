...
procedure {:inline 1} CorralChoice_contract_squeakr();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem_pages;
modifies global_0;
implementation CorralChoice_contract_squeakr()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry_contract_squeakr();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem_pages;
modifies global_0;
implementation BoogieEntry_contract_squeakr()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry_contract_squeakr();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem_pages;
modifies global_0;
implementation CorralEntry_contract_squeakr()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice_contract_squeakr();
    }
}
