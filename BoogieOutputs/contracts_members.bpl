...
procedure {:inline 1} CorralChoice_contracts_members();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
modifies $stack;
modifies $mem;
implementation CorralChoice_contracts_members()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry_contracts_members();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
modifies $stack;
modifies $mem;
implementation BoogieEntry_contracts_members()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry_contracts_members();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
modifies $stack;
modifies $mem;
implementation CorralEntry_contracts_members()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice_contracts_members();
    }
}
