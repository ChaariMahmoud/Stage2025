...
procedure {:inline 1} CorralChoice_ddos_ddos();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation CorralChoice_ddos_ddos()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry_ddos_ddos();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation BoogieEntry_ddos_ddos()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry_ddos_ddos();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation CorralEntry_ddos_ddos()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice_ddos_ddos();
    }
}
