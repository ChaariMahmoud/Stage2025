...
label$37_end_107:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$34_end_104;
    }
    goto label$33_end_103;
label$36_end_106:
    call push(loc1);
    call push(208.0);
    call popToTmp1();
...
label$51_end_137:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$48_end_134;
    }
    goto label$47_end_133;
label$50_end_136:
    call push(loc1);
    call push(208.0);
    call popToTmp1();
...
label$57_end_146:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$54_end_143;
    }
    goto label$53_end_142;
label$56_end_145:
    call push(loc1);
    call push(208.0);
    call popToTmp1();
...
procedure {:inline 1} CorralChoice_demo_demo();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation CorralChoice_demo_demo()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry_demo_demo();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation BoogieEntry_demo_demo()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry_demo_demo();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation CorralEntry_demo_demo()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice_demo_demo();
    }
}
