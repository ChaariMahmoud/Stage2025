...
procedure {:inline 1} CorralChoice_eosbet_eosbet();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation CorralChoice_eosbet_eosbet()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry_eosbet_eosbet();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation BoogieEntry_eosbet_eosbet()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry_eosbet_eosbet();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation CorralEntry_eosbet_eosbet()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice_eosbet_eosbet();
    }
}
