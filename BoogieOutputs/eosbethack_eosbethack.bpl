...
procedure {:inline 1} CorralChoice_eosbethack_eosbethack();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
modifies $stack;
modifies $mem;
implementation CorralChoice_eosbethack_eosbethack()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry_eosbethack_eosbethack();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
modifies $stack;
modifies $mem;
implementation BoogieEntry_eosbethack_eosbethack()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry_eosbethack_eosbethack();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
modifies $stack;
modifies $mem;
implementation CorralEntry_eosbethack_eosbethack()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice_eosbethack_eosbethack();
    }
}
