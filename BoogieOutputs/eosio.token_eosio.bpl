...
label$21_end_531:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$18_end_528;
    }
    goto label$17_end_527;
label$20_end_530:
    call push(loc1);
    call push(208.0);
    call popToTmp1();
