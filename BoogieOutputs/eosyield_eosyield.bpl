...
label$34_end_264:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$31_end_261;
    }
    goto label$30_end_260;
label$33_end_263:
    call push(loc2);
    call push(-48.0);
    call popToTmp1();
