...
axiom((global_1) == (17538.0));
const global_2: real;

axiom((global_2) == (17538.0));
...
procedure {:inline 1} CorralChoice_ethplay_ethplay();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem_pages;
modifies global_0;
implementation CorralChoice_ethplay_ethplay()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry_ethplay_ethplay();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem_pages;
modifies global_0;
implementation BoogieEntry_ethplay_ethplay()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry_ethplay_ethplay();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem_pages;
modifies global_0;
implementation CorralEntry_ethplay_ethplay()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice_ethplay_ethplay();
    }
}
