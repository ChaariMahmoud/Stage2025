...
axiom((global_1) == (10351.0));
const global_2: real;

axiom((global_2) == (10351.0));
...
label$6_start_764:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$8_end_768;
    }
    call push(arg4);
    call func_2();
    call loc1 := popArgs1();
    goto label$7_end_767;
label$8_end_768:
    call push(loc1);
    // // unhandled raw instruction: i32.and
    call popToTmp1();
...
label$7_end_928:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$13_end_935;
    }
    goto label$12_end_934;
label$14_end_936:
    call push(loc2);
    call push(8.0);
    call popToTmp1();
...
label$13_end_935:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$11_end_933;
    }
    goto label$10_end_932;
label$12_end_934:
    call push(1.0);
    call loc1 := popArgs1();
    // // unhandled raw instruction: i32.and
...
procedure {:inline 1} CorralChoice_forum_forum();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation CorralChoice_forum_forum()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry_forum_forum();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation BoogieEntry_forum_forum()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry_forum_forum();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation CorralEntry_forum_forum()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice_forum_forum();
    }
}
