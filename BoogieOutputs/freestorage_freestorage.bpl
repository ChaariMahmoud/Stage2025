...
procedure {:inline 1} CorralChoice_freestorage_freestorage();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
modifies $stack;
modifies $mem;
implementation CorralChoice_freestorage_freestorage()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry_freestorage_freestorage();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
modifies $stack;
modifies $mem;
implementation BoogieEntry_freestorage_freestorage()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry_freestorage_freestorage();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
modifies $stack;
modifies $mem;
implementation CorralEntry_freestorage_freestorage()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice_freestorage_freestorage();
    }
}
