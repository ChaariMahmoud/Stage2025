...
axiom((global_1) == (17504.0));
const global_2: real;

axiom((global_2) == (17504.0));
...
procedure {:inline 1} CorralChoice_gravatarcafe_gravatarcafe();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation CorralChoice_gravatarcafe_gravatarcafe()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry_gravatarcafe_gravatarcafe();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation BoogieEntry_gravatarcafe_gravatarcafe()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry_gravatarcafe_gravatarcafe();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation CorralEntry_gravatarcafe_gravatarcafe()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice_gravatarcafe_gravatarcafe();
    }
}
