...
label$15_start_157:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$19_end_163;
    }
    goto label$20_end_164;
label$21_end_165:
    call push(loc4);
    call popToTmp1();
    idx := (real_to_int($tmp1)) + (20);
...
label$20_end_164:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$18_end_162;
    }
    goto label$17_end_161;
label$19_end_163:
    call push(loc4);
    call popToTmp1();
    idx := (real_to_int($tmp1)) + (8);
