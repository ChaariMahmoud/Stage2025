...
label$15_start_84:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$19_end_89;
    }
    goto label$20_end_90;
label$21_end_91:
    call push(loc4);
    call popToTmp1();
    idx := (real_to_int($tmp1)) + (20);
...
label$20_end_90:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$18_end_88;
    }
    goto label$17_end_87;
label$19_end_89:
    call push(loc4);
    call popToTmp1();
    idx := (real_to_int($tmp1)) + (8);
