...
procedure {:inline 1} CorralChoice_hello_hello();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation CorralChoice_hello_hello()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry_hello_hello();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation BoogieEntry_hello_hello()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry_hello_hello();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation CorralEntry_hello_hello()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice_hello_hello();
    }
}
