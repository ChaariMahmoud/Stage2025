...
procedure {:inline 1} CorralChoice_import();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
modifies $stack;
implementation CorralChoice_import()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry_import();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
modifies $stack;
implementation BoogieEntry_import()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry_import();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
modifies $stack;
implementation CorralEntry_import()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice_import();
    }
}
