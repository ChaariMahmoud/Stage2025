...
label$21_end_403:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$18_end_400;
    }
    goto label$17_end_399;
label$20_end_402:
    call push(loc1);
    call push(208.0);
    call popToTmp1();
...
label$8_end_551:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$2_end_541;
    }
    goto label$1_end_540;
label$7_end_550:
    call push(arg1);
    call popToTmp1();
    idx := (real_to_int($tmp1)) + (4);
...
procedure {:inline 1} CorralChoice_keepscore_keepscore();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation CorralChoice_keepscore_keepscore()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry_keepscore_keepscore();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation BoogieEntry_keepscore_keepscore()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry_keepscore_keepscore();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation CorralEntry_keepscore_keepscore()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice_keepscore_keepscore();
    }
}
