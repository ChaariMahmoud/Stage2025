...
label$30_end_53:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$27_end_50;
    }
    goto label$26_end_49;
label$29_end_52:
    call push(arg1);
    call push(208.0);
    call popToTmp1();
...
label$36_end_62:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$33_end_59;
    }
    goto label$32_end_58;
label$35_end_61:
    call push(arg1);
    call push(208.0);
    call popToTmp1();
...
label$42_end_71:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$39_end_68;
    }
    goto label$38_end_67;
label$41_end_70:
    call push(arg1);
    call push(208.0);
    call popToTmp1();
...
label$38_end_67:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$44_end_76;
    }
    goto label$43_end_75;
label$45_end_77:
    call push(arg2);
    call push(16.0);
    call popToTmp1();
...
label$5_end_617:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$8_end_622;
    }
    call push(loc3);
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$7_end_621;
    }
    call push(loc2);
    call push(254.0);
    call popToTmp1();
...
label$8_end_690:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$6_end_688;
    }
    goto label$5_end_687;
label$7_end_689:
    call push(0.0);
    call loc18 := popArgs1();
    call push(loc5);
...
procedure {:inline 1} CorralChoice_kingofeos_kingofeos();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation CorralChoice_kingofeos_kingofeos()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry_kingofeos_kingofeos();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation BoogieEntry_kingofeos_kingofeos()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry_kingofeos_kingofeos();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation CorralEntry_kingofeos_kingofeos()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice_kingofeos_kingofeos();
    }
}
