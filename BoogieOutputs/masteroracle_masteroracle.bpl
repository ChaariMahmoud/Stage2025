...
axiom((global_1) == (17446.0));
const global_2: real;

axiom((global_2) == (17446.0));
...
label$8_end_16:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$12_end_21;
    }
    goto label$11_end_20;
label$18_end_27:
    call push(arg3);
    call push(2147483647.0);
    call popToTmp1();
...
procedure {:inline 1} CorralChoice_masteroracle_masteroracle();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation CorralChoice_masteroracle_masteroracle()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry_masteroracle_masteroracle();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation BoogieEntry_masteroracle_masteroracle()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry_masteroracle_masteroracle();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation CorralEntry_masteroracle_masteroracle()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice_masteroracle_masteroracle();
    }
}
