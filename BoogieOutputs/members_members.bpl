...
procedure {:inline 1} CorralChoice_members_members();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
modifies $stack;
modifies $mem;
implementation CorralChoice_members_members()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry_members_members();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
modifies $stack;
modifies $mem;
implementation BoogieEntry_members_members()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry_members_members();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
modifies $stack;
modifies $mem;
implementation CorralEntry_members_members()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice_members_members();
    }
}
