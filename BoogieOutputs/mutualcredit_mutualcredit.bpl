...
axiom((global_1) == (17368.0));
const global_2: real;

axiom((global_2) == (17368.0));
...
procedure {:inline 1} CorralChoice_mutualcredit_mutualcredit();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem_pages;
modifies global_0;
implementation CorralChoice_mutualcredit_mutualcredit()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry_mutualcredit_mutualcredit();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem_pages;
modifies global_0;
implementation BoogieEntry_mutualcredit_mutualcredit()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry_mutualcredit_mutualcredit();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem_pages;
modifies global_0;
implementation CorralEntry_mutualcredit_mutualcredit()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice_mutualcredit_mutualcredit();
    }
}
