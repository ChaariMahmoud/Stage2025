...
axiom((global_1) == (17152.0));
const global_2: real;

axiom((global_2) == (17152.0));
...
procedure {:inline 1} CorralChoice_myprofile_myprofile();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation CorralChoice_myprofile_myprofile()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry_myprofile_myprofile();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation BoogieEntry_myprofile_myprofile()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry_myprofile_myprofile();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation CorralEntry_myprofile_myprofile()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice_myprofile_myprofile();
    }
}
