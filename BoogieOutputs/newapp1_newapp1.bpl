...
axiom((global_1) == (17462.0));
const global_2: real;

axiom((global_2) == (17462.0));
...
procedure {:inline 1} CorralChoice_newapp1_newapp1();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem_pages;
modifies global_0;
implementation CorralChoice_newapp1_newapp1()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry_newapp1_newapp1();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem_pages;
modifies global_0;
implementation BoogieEntry_newapp1_newapp1()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry_newapp1_newapp1();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem_pages;
modifies global_0;
implementation CorralEntry_newapp1_newapp1()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice_newapp1_newapp1();
    }
}
