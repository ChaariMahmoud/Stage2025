...
label$2_end_57:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$23_end_95;
    }
    call popToTmp1();
    idx := real_to_int($tmp1);
    if (((idx) < (0)) || ((idx) >= (10))) {
        goto label$26_end_99;
    } else {
        if ((idx) == (0)) {
            goto label$26_end_99;
        }
...
label$20_end_92:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$51_end_126;
    }
    call popToTmp1();
    idx := real_to_int($tmp1);
    if (((idx) < (0)) || ((idx) >= (84))) {
        goto label$55_end_132;
    } else {
        if ((idx) == (0)) {
            goto label$55_end_132;
        }
...
label$56_end_133:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$69_end_154;
    }
label$70_end_155:
    // // unhandled raw instruction: i32.and
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$68_end_153;
    }
    // // unhandled raw instruction: i32.and
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$67_end_152;
    }
    // // unhandled raw instruction: i32.and
    call popToTmp1();
    if (real_to_bool($tmp1)) {
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$29_end_104;
    }
    goto label$30_end_105;
label$69_end_154:
    // // unhandled raw instruction: i32.and
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$66_end_151;
    }
    // // unhandled raw instruction: i32.and
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$45_end_120;
    }
    // // unhandled raw instruction: i32.and
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$44_end_119;
    }
    call push(loc3);
    // // unhandled raw instruction: i32.and
    // // unhandled raw instruction: i32.and
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$43_end_118;
    }
    goto label$42_end_117;
label$68_end_153:
    call push(loc3);
    // // unhandled raw instruction: i32.and
    // // unhandled raw instruction: i32.and
...
label$47_end_122:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$89_end_210;
    }
    call push(0.0);
    call arg5 := popArgs1();
    goto label$88_end_209;
label$89_end_210:
...
label$115_end_256:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$116_end_257;
    }
    // // unhandled raw instruction: i32.xor
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$118_end_259;
    }
    call push(loc1);
    call push(loc3);
    call popToTmp1();
    ...
    store_i := real_to_int($tmp2);
    call mem_write_u8(idx, store_i);
    goto label$117_end_258;
label$118_end_259:
    // // unhandled raw instruction: i32.and
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$119_end_260;
    }
    // // unhandled raw instruction: i32.and
    call popToTmp1();
    call push(bool_to_real(($tmp1) == (0.0)));
...
label$13_end_296:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$15_end_298;
    }
    goto label$14_end_297;
label$17_end_300:
    // // unhandled raw instruction: i32.and
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$18_end_301;
    }
    // // unhandled raw instruction: i32.and
    call popToTmp1();
    call push(bool_to_real(($tmp1) == (0.0)));
...
label$18_start_387:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$18_start_387;
    }
    goto label$16_end_385;
label$19_end_389:
    call push(loc5);
    call arg2 := popArgs1();
label$20_start_391:
...
label$1_end_460:
    ...
    // // unhandled raw instruction: i64.rem_s
    call popToTmp1();
    call popToTmp2();
    call push(($tmp2) * ($tmp1));
    call loc7 := popArgs1();
...
label$1_end_499:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$22_end_537;
    }
    call push(-2147483648.0);
    call loc7 := popArgs1();
    goto label$21_end_536;
label$22_end_537:
    // // unhandled raw instruction: i64.trunc_f64_s
    call loc7 := popArgs1();
label$21_end_536:
...
implementation func_57()
{
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$3_end_1052;
    }
    call push(loc3);
    call func_2();
    call loc1 := popArgs1();
    goto label$2_end_1051;
label$4_end_1053:
    call push(0.0);
    call loc1 := popArgs1();
...
implementation func_65()
{
    ...
    // // unhandled raw instruction: i32.or
    call loc4 := popArgs1();
    goto label$6_end_1219;
label$8_end_1221:
    // // unhandled raw instruction: i32.and
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$5_end_1218;
    }
    call push(arg2);
    call push(0.0);
    call popToTmp2();
...
label$4_end_1310:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$8_end_1318;
    }
    goto label$7_end_1317;
label$9_end_1319:
    call push(arg1);
    call push(24.0);
    call popToTmp1();
