...
axiom((global_1) == (17230.0));
const global_2: real;

axiom((global_2) == (17230.0));
...
procedure {:inline 1} CorralChoice_priceoracliz_priceoracliz();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem_pages;
modifies global_0;
implementation CorralChoice_priceoracliz_priceoracliz()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry_priceoracliz_priceoracliz();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem_pages;
modifies global_0;
implementation BoogieEntry_priceoracliz_priceoracliz()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry_priceoracliz_priceoracliz();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem_pages;
modifies global_0;
implementation CorralEntry_priceoracliz_priceoracliz()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice_priceoracliz_priceoracliz();
    }
}
