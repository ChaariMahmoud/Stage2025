...
procedure {:inline 1} CorralChoice_ramconsumer_ramconsumer();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation CorralChoice_ramconsumer_ramconsumer()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry_ramconsumer_ramconsumer();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation BoogieEntry_ramconsumer_ramconsumer()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry_ramconsumer_ramconsumer();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation CorralEntry_ramconsumer_ramconsumer()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice_ramconsumer_ramconsumer();
    }
}
