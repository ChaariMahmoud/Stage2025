...
procedure {:inline 1} CorralChoice_reader_reader();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation CorralChoice_reader_reader()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry_reader_reader();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation BoogieEntry_reader_reader()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry_reader_reader();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation CorralEntry_reader_reader()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice_reader_reader();
    }
}
