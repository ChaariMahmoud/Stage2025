...
axiom((global_1) == (17300.0));
const global_2: real;

axiom((global_2) == (17300.0));
...
label$29_end_47:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$36_end_56;
    }
    goto label$35_end_55;
label$37_end_57:
    call push(loc2);
    call push(52.0);
    call popToTmp1();
...
label$36_end_56:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$34_end_54;
    }
    goto label$33_end_53;
label$35_end_55:
    call push(1.0);
    call loc3 := popArgs1();
    call push(loc2);
...
label$34_end_54:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$31_end_51;
    }
    goto label$32_end_52;
label$33_end_53:
    call push(loc2);
    call push(28.0);
    call popToTmp1();
...
label$15_end_144:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$18_end_150;
    }
    goto label$17_end_149;
label$19_end_151:
    call push(loc4);
    call func_38();
    call push(loc12);
...
label$23_end_232:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$20_end_229;
    }
    goto label$21_end_230;
label$22_end_231:
    call push(loc4);
    call push(28.0);
    call popToTmp1();
...
label$13_end_274:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$16_end_278;
    }
    call push(loc5);
    call func_35();
    call loc3 := popArgs1();
    goto label$15_end_277;
label$16_end_278:
    call push(loc1);
    call push(loc5);
    call push(15.0);
...
procedure {:inline 1} CorralChoice_recruit_recruit();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem_pages;
modifies global_0;
implementation CorralChoice_recruit_recruit()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry_recruit_recruit();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem_pages;
modifies global_0;
implementation BoogieEntry_recruit_recruit()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry_recruit_recruit();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem_pages;
modifies global_0;
implementation CorralEntry_recruit_recruit()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice_recruit_recruit();
    }
}
