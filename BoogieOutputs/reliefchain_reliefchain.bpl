...
procedure {:inline 1} CorralChoice_reliefchain_reliefchain();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
modifies $stack;
modifies $mem;
implementation CorralChoice_reliefchain_reliefchain()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry_reliefchain_reliefchain();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
modifies $stack;
modifies $mem;
implementation BoogieEntry_reliefchain_reliefchain()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry_reliefchain_reliefchain();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
modifies $stack;
modifies $mem;
implementation CorralEntry_reliefchain_reliefchain()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice_reliefchain_reliefchain();
    }
}
