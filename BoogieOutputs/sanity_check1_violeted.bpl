...
procedure {:inline 1} CorralChoice_sanity_check1_violeted();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
requires(((0.0) <= (stock)) && ((stock) <= (CAPACITY)));
ensures(((0.0) <= (stock)) && ((stock) <= (CAPACITY)));
implementation CorralChoice_sanity_check1_violeted()
{
    var c: int;
    havoc c;
    assume (((0) <= (c)) && ((c) < (2)));
...
procedure BoogieEntry_sanity_check1_violeted();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
requires(((0.0) <= (stock)) && ((stock) <= (CAPACITY)));
ensures(((0.0) <= (stock)) && ((stock) <= (CAPACITY)));
implementation BoogieEntry_sanity_check1_violeted()
{
    var c: int;
    call initGlobals();
    call InitRuntime();
...
procedure CorralEntry_sanity_check1_violeted();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
requires(((0.0) <= (stock)) && ((stock) <= (CAPACITY)));
ensures(((0.0) <= (stock)) && ((stock) <= (CAPACITY)));
implementation CorralEntry_sanity_check1_violeted()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice_sanity_check1_violeted();
    }
}
