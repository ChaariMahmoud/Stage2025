...
procedure {:inline 1} CorralChoice_sanity_check2_violeted();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
requires(((0.0) <= (temp)) && ((temp) <= (100.0)));
ensures(((0.0) <= (temp)) && ((temp) <= (100.0)));
implementation CorralChoice_sanity_check2_violeted()
{
    var c: int;
    havoc c;
    assume (((0) <= (c)) && ((c) < (2)));
...
requires(((0.0) <= (temp)) && ((temp) <= (100.0)));
ensures(((0.0) <= (temp)) && ((temp) <= (100.0)));
implementation BoogieEntry_sanity_check2_violeted()
{
    var c: int;
    call initGlobals();
    call InitRuntime();
...
implementation CorralEntry_sanity_check2_violeted()
{
    ...
    while (true)
    {
        call CorralChoice_sanity_check2_violeted();
    }
}
