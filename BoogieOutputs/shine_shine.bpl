...
procedure {:inline 1} CorralChoice_shine_shine();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation CorralChoice_shine_shine()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry_shine_shine();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation BoogieEntry_shine_shine()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry_shine_shine();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation CorralEntry_shine_shine()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice_shine_shine();
    }
}
