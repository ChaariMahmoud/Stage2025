...
procedure {:inline 1} CorralChoice_src_gravatarcafe();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation CorralChoice_src_gravatarcafe()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry_src_gravatarcafe();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation BoogieEntry_src_gravatarcafe()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry_src_gravatarcafe();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation CorralEntry_src_gravatarcafe()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice_src_gravatarcafe();
    }
}
