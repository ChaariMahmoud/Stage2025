...
procedure {:inline 1} CorralChoice_stealram_stealram();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
modifies $stack;
modifies $mem;
implementation CorralChoice_stealram_stealram()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry_stealram_stealram();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
modifies $stack;
modifies $mem;
implementation BoogieEntry_stealram_stealram()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry_stealram_stealram();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
modifies $stack;
modifies $mem;
implementation CorralEntry_stealram_stealram()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice_stealram_stealram();
    }
}
