...
axiom((global_1) == (17524.0));
const global_2: real;

axiom((global_2) == (17524.0));
...
procedure {:inline 1} CorralChoice_test_da_test_da();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation CorralChoice_test_da_test_da()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry_test_da_test_da();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation BoogieEntry_test_da_test_da()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry_test_da_test_da();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation CorralEntry_test_da_test_da()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice_test_da_test_da();
    }
}
