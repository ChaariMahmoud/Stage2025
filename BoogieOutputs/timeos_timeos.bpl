...
axiom((global_1) == (17244.0));
const global_2: real;

axiom((global_2) == (17244.0));
...
procedure {:inline 1} CorralChoice_timeos_timeos();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem_pages;
modifies global_0;
implementation CorralChoice_timeos_timeos()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry_timeos_timeos();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem_pages;
modifies global_0;
implementation BoogieEntry_timeos_timeos()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry_timeos_timeos();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem_pages;
modifies global_0;
implementation CorralEntry_timeos_timeos()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice_timeos_timeos();
    }
}
