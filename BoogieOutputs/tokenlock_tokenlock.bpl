...
procedure {:inline 1} CorralChoice_tokenlock_tokenlock();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
modifies $stack;
modifies $mem;
implementation CorralChoice_tokenlock_tokenlock()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry_tokenlock_tokenlock();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
modifies $stack;
modifies $mem;
implementation BoogieEntry_tokenlock_tokenlock()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry_tokenlock_tokenlock();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
modifies $stack;
modifies $mem;
implementation CorralEntry_tokenlock_tokenlock()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice_tokenlock_tokenlock();
    }
}
