...
label$4_start_433:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$8_end_439;
    }
    goto label$9_end_440;
label$10_end_441:
    // // unhandled raw instruction: i32.and
    call popToTmp1();
    call push(bool_to_real(($tmp1) == (0.0)));
...
label$8_end_588:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$10_end_590;
    }
    call push(loc5);
    call func_65();
    call loc8 := popArgs1();
    goto label$9_end_589;
label$10_end_590:
    call push(loc1);
    // // unhandled raw instruction: i32.and
    call popToTmp1();
...
label$15_start_707:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$19_end_713;
    }
    goto label$20_end_714;
label$21_end_715:
    // // unhandled raw instruction: i32.and
    call popToTmp1();
    call push(bool_to_real(($tmp1) == (0.0)));
...
label$20_end_714:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$18_end_712;
    }
    goto label$17_end_711;
label$19_end_713:
    // // unhandled raw instruction: i32.and
    call popToTmp1();
    call push(bool_to_real(($tmp1) == (0.0)));
...
label$2_start_841:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$6_end_847;
    }
    goto label$7_end_848;
label$8_end_849:
    // // unhandled raw instruction: i32.and
    call popToTmp1();
    call push(bool_to_real(($tmp1) == (0.0)));
...
label$5_end_991:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$8_end_995;
    }
    call push(loc6);
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$7_end_994;
    }
    // // unhandled raw instruction: i32.shr_u
    call loc3 := popArgs1();
    goto label$6_end_993;
label$8_end_995:
    call push(loc6);
    call popToTmp1();
    if (real_to_bool($tmp1)) {
