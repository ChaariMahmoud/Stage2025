...
axiom((global_1) == (17450.0));
const global_2: real;

axiom((global_2) == (17450.0));
...
label$3_start_73:
    ...
    if (((idx) < (0)) || ((idx) >= (21))) {
        goto label$36_end_107;
    } else {
        if ((idx) == (0)) {
            goto label$39_end_110;
        }
        if ((idx) == (1)) {
            goto label$38_end_109;
        }
        if ((idx) == (2)) {
            goto label$35_end_106;
        }
        if ((idx) == (3)) {
            goto label$34_end_105;
        }
        if ((idx) == (4)) {
            goto label$40_end_111;
        }
        if ((idx) == (5)) {
            goto label$33_end_104;
        }
        if ((idx) == (6)) {
            goto label$32_end_103;
        }
        if ((idx) == (7)) {
            goto label$31_end_102;
        }
        if ((idx) == (8)) {
            goto label$30_end_101;
        }
        if ((idx) == (9)) {
            goto label$29_end_100;
        }
        if ((idx) == (10)) {
            goto label$28_end_99;
        }
        if ((idx) == (11)) {
            goto label$27_end_98;
        }
        if ((idx) == (12)) {
            goto label$26_end_97;
        }
        if ((idx) == (13)) {
        ...
        if ((idx) == (15)) {
            goto label$23_end_94;
        }
        if ((idx) == (16)) {
            goto label$21_end_92;
        }
        if ((idx) == (17)) {
            goto label$20_end_91;
        }
        if ((idx) == (18)) {
            goto label$22_end_93;
        }
        if ((idx) == (19)) {
            goto label$37_end_108;
        }
        if ((idx) == (20)) {
            goto label$36_end_107;
        }
...
label$38_end_109:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$13_end_84;
    }
    goto label$14_end_85;
label$37_end_108:
    call push(loc6);
    call push(loc7);
    call popToTmp1();
...
label$36_end_107:
    ...
    call popToTmp1();
    if (real_to_bool($tmp1)) {
        goto label$16_end_87;
    }
    goto label$17_end_88;
label$35_end_106:
    call push(loc1);
    call popToTmp1();
    idx := (real_to_int($tmp1)) + (8);
...
procedure {:inline 1} CorralChoice_user_user();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation CorralChoice_user_user()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry_user_user();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation BoogieEntry_user_user()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry_user_user();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation CorralEntry_user_user()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice_user_user();
    }
}
