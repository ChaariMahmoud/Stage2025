...
axiom((global_1) == (9101.0));
const global_2: real;

axiom((global_2) == (9101.0));
...
procedure {:inline 1} CorralChoice_watchdoggiee_watchdoggiee();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation CorralChoice_watchdoggiee_watchdoggiee()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry_watchdoggiee_watchdoggiee();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation BoogieEntry_watchdoggiee_watchdoggiee()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry_watchdoggiee_watchdoggiee();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies global_0;
implementation CorralEntry_watchdoggiee_watchdoggiee()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice_watchdoggiee_watchdoggiee();
    }
}
