...
procedure {:inline 1} convert_it_u();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
procedure {:inline 1} CorralChoice_convert_it_u();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation CorralChoice_convert_it_u()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry_convert_it_u();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation BoogieEntry_convert_it_u()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry_convert_it_u();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation CorralEntry_convert_it_u()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice_convert_it_u();
    }
}
