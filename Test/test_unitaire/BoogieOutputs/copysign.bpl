...
procedure {:inline 1} CorralChoice_copysign();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation CorralChoice_copysign()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry_copysign();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation BoogieEntry_copysign()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry_copysign();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation CorralEntry_copysign()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice_copysign();
    }
}
