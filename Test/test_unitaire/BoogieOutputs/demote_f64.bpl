...
procedure {:inline 1} CorralChoice_demote_f64();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation CorralChoice_demote_f64()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry_demote_f64();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation BoogieEntry_demote_f64()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry_demote_f64();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation CorralEntry_demote_f64()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice_demote_f64();
    }
}
