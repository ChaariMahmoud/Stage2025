...
procedure {:inline 1} extend_i32_u();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
procedure {:inline 1} CorralChoice_extend_i32_u();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation CorralChoice_extend_i32_u()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry_extend_i32_u();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation BoogieEntry_extend_i32_u()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry_extend_i32_u();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation CorralEntry_extend_i32_u()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice_extend_i32_u();
    }
}
