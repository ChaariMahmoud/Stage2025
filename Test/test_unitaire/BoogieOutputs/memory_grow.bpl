...
procedure {:inline 1} memory_grow();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
procedure {:inline 1} CorralChoice_memory_grow();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation CorralChoice_memory_grow()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry_memory_grow();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation BoogieEntry_memory_grow()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry_memory_grow();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation CorralEntry_memory_grow()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice_memory_grow();
    }
}
