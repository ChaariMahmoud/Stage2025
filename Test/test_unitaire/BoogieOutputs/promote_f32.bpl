...
procedure {:inline 1} promote_f32();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
procedure {:inline 1} CorralChoice_promote_f32();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation CorralChoice_promote_f32()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry_promote_f32();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation BoogieEntry_promote_f32()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry_promote_f32();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation CorralEntry_promote_f32()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice_promote_f32();
    }
}
