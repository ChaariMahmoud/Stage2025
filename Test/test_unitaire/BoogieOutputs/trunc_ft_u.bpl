...
procedure {:inline 1} CorralChoice_trunc_ft_u();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation CorralChoice_trunc_ft_u()
{
    var c: int;
    var argTmp: real;
    havoc c;
...
procedure BoogieEntry_trunc_ft_u();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation BoogieEntry_trunc_ft_u()
{
    var c: int;
    var argTmp: real;
    call initGlobals();
...
procedure CorralEntry_trunc_ft_u();
modifies $tmp1;
modifies $tmp2;
modifies $tmp3;
modifies $sp;
...
modifies $mem;
modifies $mem_pages;
implementation CorralEntry_trunc_ft_u()
{
    call InitRuntime();
    call initGlobals();
    while (true)
    {
        call CorralChoice_trunc_ft_u();
    }
}
