...
implementation {:ForceInline} acquire_request()
{
  ...
  anon4_Else:
    ...
    call {:si_unique_call 11} push(5e0);
...
implementation {:ForceInline} CorralChoice_request_err_spec()
{
  var c: int;
  ...
  anon3_Then:
    ...
    assert 0e0 <= active_requests && active_requests <= MAX_REQUESTS;
    return;
...
implementation CorralEntry_request_err_spec()
{
  ...
  anon2_LoopBody:
    ...
    call {:si_unique_call 38} CorralChoice_request_err_spec();
    goto anon2_LoopHead;
