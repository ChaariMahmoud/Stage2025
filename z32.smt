...
(declare-fun $tmp2@0 () Real)
(declare-fun $tmp1@0 () Real)
(declare-fun call0formal@val@0@@0 () Real)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= call0formal@val@0 (+ $tmp2@0 $tmp1@0)) (=> (and (= call0formal@val@0@@0 (bool_to_real (= $tmp2@1 $tmp1@1))) (= (ControlFlow 0 2) (- 0 1))) (= $sp@9 (- $sp 2))))))
